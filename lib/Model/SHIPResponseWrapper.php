...
class SHIPResponseWrapper implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'shipmentResponse' => '\OpenAPIClientUPSShipping\Model\ShipmentResponse'
    ];
    ...
    protected static $setters = [
        'shipmentResponse' => 'setShipmentResponse'
    ];
    ...
    protected static $getters = [
        'shipmentResponse' => 'getShipmentResponse'
    ];
    ...
    {
        $this->setIfExists('shipmentResponse', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['shipmentResponse'] === null) {
            $invalidProperties[] = "'shipmentResponse' can't be null";
        }
    ...
    /**
     * Gets shipmentResponse
     *
     * @return \OpenAPIClientUPSShipping\Model\ShipmentResponse
     */
    public function getShipmentResponse()
    {
        return $this->container['shipmentResponse'];
    }

    /**
     * Sets shipmentResponse
     *
     * @param \OpenAPIClientUPSShipping\Model\ShipmentResponse $shipmentResponse shipmentResponse
     *
     * @return self
     */
    public function setShipmentResponse($shipmentResponse)
    {
        if (is_null($shipmentResponse)) {
            throw new \InvalidArgumentException('non-nullable shipmentResponse cannot be null');
        }
        $this->container['shipmentResponse'] = $shipmentResponse;
