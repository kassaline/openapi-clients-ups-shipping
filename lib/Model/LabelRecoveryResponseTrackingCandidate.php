...
class LabelRecoveryResponseTrackingCandidate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'pickupDateRange' => '\OpenAPIClientUPSShipping\Model\TrackingCandidatePickupDateRange'
    ];
    ...
    protected static $getters = [
        ...
        'pickupDateRange' => 'getPickupDateRange'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('pickupDateRange', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['destinationPostalCode']) && (mb_strlen($this->container['destinationPostalCode']) > 9)) {
            $invalidProperties[] = "invalid value for 'destinationPostalCode', the character length must be smaller than or equal to 9.";
        }

        if (!is_null($this->container['destinationPostalCode']) && (mb_strlen($this->container['destinationPostalCode']) < 1)) {
            $invalidProperties[] = "invalid value for 'destinationPostalCode', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['destinationCountryCode']) && (mb_strlen($this->container['destinationCountryCode']) > 2)) {
     ...
     * Sets trackingNumber
     *
     * @param string $trackingNumber Packaging Tracking Number  Only supported for the web small package shipment so only supported 18 digit
     *
     * @return self
     */
    public function setTrackingNumber($trackingNumber)
    {
        ...
        if ((mb_strlen($trackingNumber) > 18)) {
            throw new \InvalidArgumentException('invalid length for $trackingNumber when calling LabelRecoveryResponseTrackingCandidate., must be smaller than or equal to 18.');
        }
        if ((mb_strlen($trackingNumber) < 18)) {
            throw new \InvalidArgumentException('invalid length for $trackingNumber when calling LabelRecoveryResponseTrackingCandidate., must be bigger than or equal to 18.');
        }
     ...
     *
     * @param string|null $destinationPostalCode Destination postal code candidate
     *
     * @return self
     */
    public function setDestinationPostalCode($destinationPostalCode)
    {
        ...
        if ((mb_strlen($destinationPostalCode) > 9)) {
            throw new \InvalidArgumentException('invalid length for $destinationPostalCode when calling LabelRecoveryResponseTrackingCandidate., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($destinationPostalCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $destinationPostalCode when calling LabelRecoveryResponseTrackingCandidate., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $destinationCountryCode Destination country or territory code candidate, like US = USA, CA = Canada  Must be valid ups country or territory code. This is required, if MasterEUConsolidationIndicator is \"1\".
     *
     * @return self
     */
    public function setDestinationCountryCode($destinationCountryCode)
    {
        ...
        if ((mb_strlen($destinationCountryCode) > 2)) {
            throw new \InvalidArgumentException('invalid length for $destinationCountryCode when calling LabelRecoveryResponseTrackingCandidate., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($destinationCountryCode) < 2)) {
            throw new \InvalidArgumentException('invalid length for $destinationCountryCode when calling LabelRecoveryResponseTrackingCandidate., must be bigger than or equal to 2.');
        }
    ...
    /**
     * Gets pickupDateRange
     *
     * @return \OpenAPIClientUPSShipping\Model\TrackingCandidatePickupDateRange|null
     */
    public function getPickupDateRange()
    {
        return $this->container['pickupDateRange'];
    }

    /**
     * Sets pickupDateRange
     *
     * @param \OpenAPIClientUPSShipping\Model\TrackingCandidatePickupDateRange|null $pickupDateRange pickupDateRange
     *
     * @return self
     */
    public function setPickupDateRange($pickupDateRange)
    {
        if (is_null($pickupDateRange)) {
            throw new \InvalidArgumentException('non-nullable pickupDateRange cannot be null');
        }
        $this->container['pickupDateRange'] = $pickupDateRange;
