...
class FRSShipmentDataFreightDensityRate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        'density' => 'setDensity',
        'totalCubicFeet' => 'setTotalCubicFeet'
    ];
    ...
    protected static $getters = [
        'density' => 'getDensity',
        'totalCubicFeet' => 'getTotalCubicFeet'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('totalCubicFeet', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['totalCubicFeet'] === null) {
            $invalidProperties[] = "'totalCubicFeet' can't be null";
        }
        if ((mb_strlen($this->container['totalCubicFeet']) > 9)) {
            $invalidProperties[] = "invalid value for 'totalCubicFeet', the character length must be smaller than or equal to 9.";
        }

        if ((mb_strlen($this->container['totalCubicFeet']) < 1)) {
            $invalidProperties[] = "invalid value for 'totalCubicFeet', the character length must be bigger than or equal to 1.";
        }
    ...
    {
        return $this->container['totalCubicFeet'];
    }

    /**
     * Sets totalCubicFeet
     *
     * @param string $totalCubicFeet Total Cubic feet is returned if the Shipper is eligible for Density based rate.   Valid values are 0 to 99999.999
     *
     * @return self
     */
    public function setTotalCubicFeet($totalCubicFeet)
    {
        if (is_null($totalCubicFeet)) {
            throw new \InvalidArgumentException('non-nullable totalCubicFeet cannot be null');
        }
        if ((mb_strlen($totalCubicFeet) > 9)) {
            throw new \InvalidArgumentException('invalid length for $totalCubicFeet when calling FRSShipmentDataFreightDensityRate., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($totalCubicFeet) < 1)) {
            throw new \InvalidArgumentException('invalid length for $totalCubicFeet when calling FRSShipmentDataFreightDensityRate., must be bigger than or equal to 1.');
        }

        $this->container['totalCubicFeet'] = $totalCubicFeet;
