...
/**
 * MasterSoldTo Class Doc Comment
 *
 * @category Class
 ...
 */
class MasterSoldTo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Master_SoldTo';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Master Sold To Company Name.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling MasterSoldTo., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling MasterSoldTo., must be bigger than or equal to 1.');
        }
     ...
     * Sets attentionName
     *
     * @param string|null $attentionName Master Sold to Contact Name.
     *
     * @return self
     */
    public function setAttentionName($attentionName)
    {
        ...
        if ((mb_strlen($attentionName) > 35)) {
            throw new \InvalidArgumentException('invalid length for $attentionName when calling MasterSoldTo., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($attentionName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $attentionName when calling MasterSoldTo., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $taxIdentificationNumber Master Sold To Tax Identification Number. This element has been deprecated, replacement can be found in the GlobalTaxInformation container.
     *
     * @return self
     * @deprecated
     */
    public function setTaxIdentificationNumber($taxIdentificationNumber)
    {
        ...
        if ((mb_strlen($taxIdentificationNumber) > 15)) {
            throw new \InvalidArgumentException('invalid length for $taxIdentificationNumber when calling MasterSoldTo., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($taxIdentificationNumber) < 1)) {
            throw new \InvalidArgumentException('invalid length for $taxIdentificationNumber when calling MasterSoldTo., must be bigger than or equal to 1.');
        }
    ...
    public function setOption($option)
    {
        ...
        if ((mb_strlen($option) > 2)) {
            throw new \InvalidArgumentException('invalid length for $option when calling MasterSoldTo., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($option) < 2)) {
            throw new \InvalidArgumentException('invalid length for $option when calling MasterSoldTo., must be bigger than or equal to 2.');
        }
     ...
     * Sets emailAddress
     *
     * @param string $emailAddress Master Sold To Email Address.
     *
     * @return self
     */
    public function setEmailAddress($emailAddress)
    {
        ...
        if ((mb_strlen($emailAddress) > 50)) {
            throw new \InvalidArgumentException('invalid length for $emailAddress when calling MasterSoldTo., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($emailAddress) < 1)) {
            throw new \InvalidArgumentException('invalid length for $emailAddress when calling MasterSoldTo., must be bigger than or equal to 1.');
        }
     ...
     * Sets accountNumber
     *
     * @param string|null $accountNumber Master Sold To Account Number.
     *
     * @return self
     */
    public function setAccountNumber($accountNumber)
    {
        ...
        if ((mb_strlen($accountNumber) > 6)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling MasterSoldTo., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($accountNumber) < 1)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling MasterSoldTo., must be bigger than or equal to 1.');
        }
