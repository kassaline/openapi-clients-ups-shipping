...
class PackageResultsRateModifier implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['modifierDesc']) < 1)) {
            $invalidProperties[] = "invalid value for 'modifierDesc', the character length must be bigger than or equal to 1.";
        }
     ...
     * Sets modifierType
     *
     * @param string $modifierType Rate Modifier Type. Example: \"ORM\". Applies only if SubVersion is 2205 or greater.
     *
     * @return self
     */
    public function setModifierType($modifierType)
    {
        ...
        if ((mb_strlen($modifierType) > 3)) {
            throw new \InvalidArgumentException('invalid length for $modifierType when calling PackageResultsRateModifier., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($modifierType) < 3)) {
            throw new \InvalidArgumentException('invalid length for $modifierType when calling PackageResultsRateModifier., must be bigger than or equal to 3.');
        }
     ...
     * Sets modifierDesc
     *
     * @param string $modifierDesc Rate Modifier Description. Example: \"Origin Modifier\". Applies only if SubVersion is 2205 or greater.
     *
     * @return self
     */
    public function setModifierDesc($modifierDesc)
    {
        ...
        if ((mb_strlen($modifierDesc) > 50)) {
            throw new \InvalidArgumentException('invalid length for $modifierDesc when calling PackageResultsRateModifier., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($modifierDesc) < 1)) {
            throw new \InvalidArgumentException('invalid length for $modifierDesc when calling PackageResultsRateModifier., must be bigger than or equal to 1.');
        }
