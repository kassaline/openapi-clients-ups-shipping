...
class ShipToAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'residentialAddressIndicator' => 'setResidentialAddressIndicator',
        'pOBoxIndicator' => 'setPOBoxIndicator'
    ];
    ...
    protected static $getters = [
        ...
        'residentialAddressIndicator' => 'getResidentialAddressIndicator',
        'pOBoxIndicator' => 'getPOBoxIndicator'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('residentialAddressIndicator', $data ?? [], null);
        $this->setIfExists('pOBoxIndicator', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets addressLine
     *
     * @param string[] $addressLine Address Line of the consignee. All three Address Lines will be printed on the label.
     *
     * @return self
     */
     ...
     *
     * @param string|null $stateProvinceCode Consignee's state or province code. Required for US or Canada.  If destination is US or CA, then the value must be a valid US State/ Canadian Province code.  If the country or territory is Ireland, the StateProvinceCode will contain the county.
     *
     * @return self
     */
    public function setStateProvinceCode($stateProvinceCode)
    {
        ...
        if ((mb_strlen($stateProvinceCode) > 5)) {
            throw new \InvalidArgumentException('invalid length for $stateProvinceCode when calling ShipToAddress., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($stateProvinceCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $stateProvinceCode when calling ShipToAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setPostalCode($postalCode)
    {
        ...
        if ((mb_strlen($postalCode) > 9)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling ShipToAddress., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($postalCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling ShipToAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setCountryCode($countryCode)
    {
        ...
        if ((mb_strlen($countryCode) > 2)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling ShipToAddress., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($countryCode) < 2)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling ShipToAddress., must be bigger than or equal to 2.');
        }
    ...
    /**
     * Gets residentialAddressIndicator
     *
     * @return string|null
     */
    public function getResidentialAddressIndicator()
    {
        return $this->container['residentialAddressIndicator'];
    }

    /**
     * Sets residentialAddressIndicator
     *
     * @param string|null $residentialAddressIndicator This field is a flag to indicate if the receiver is a residential location.  True if ResidentialAddressIndicator tag exists.  This is an empty tag, any value inside is ignored.
     *
     * @return self
     */
    public function setResidentialAddressIndicator($residentialAddressIndicator)
    {
        if (is_null($residentialAddressIndicator)) {
            throw new \InvalidArgumentException('non-nullable residentialAddressIndicator cannot be null');
        }


        $this->container['residentialAddressIndicator'] = $residentialAddressIndicator;
    ...
    {
        return $this->container['pOBoxIndicator'];
    }

    /**
     * Sets pOBoxIndicator
     *
     * @param string|null $pOBoxIndicator This field is a flag to indicate if the receiver address has PO box indicator. True if POBoxIndicator tag exists; false otherwise.
     *
     * @return self
     */
    public function setPOBoxIndicator($pOBoxIndicator)
    {
        if (is_null($pOBoxIndicator)) {
            throw new \InvalidArgumentException('non-nullable pOBoxIndicator cannot be null');
        }


        $this->container['pOBoxIndicator'] = $pOBoxIndicator;
