 ...
 */
class VoidShipmentResponsePackageLevelResults implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VoidShipmentResponse_PackageLevelResults';
    ...
    protected static $openAPITypes = [
        ...
        'status' => '\OpenAPIClientUPSShipping\Model\PackageLevelResultsStatus'
    ];
    ...
    */
     ...
     * Sets trackingNumber
     *
     * @param string $trackingNumber The package's identification number
     *
     * @return self
     */
    public function setTrackingNumber($trackingNumber)
    {
        ...
        if ((mb_strlen($trackingNumber) > 18)) {
            throw new \InvalidArgumentException('invalid length for $trackingNumber when calling VoidShipmentResponsePackageLevelResults., must be smaller than or equal to 18.');
        }
        if ((mb_strlen($trackingNumber) < 18)) {
            throw new \InvalidArgumentException('invalid length for $trackingNumber when calling VoidShipmentResponsePackageLevelResults., must be bigger than or equal to 18.');
        }
     ...
     * Gets status
     *
     * @return \OpenAPIClientUPSShipping\Model\PackageLevelResultsStatus
     */
     ...
     * Sets status
     *
     * @param \OpenAPIClientUPSShipping\Model\PackageLevelResultsStatus $status status
     *
     * @return self
     */
