...
class NegotiatedRateChargesItemizedCharges implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'monetaryValue' => 'setMonetaryValue',
        'subType' => 'setSubType'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('monetaryValue', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['monetaryValue'] === null) {
            $invalidProperties[] = "'monetaryValue' can't be null";
        }
        if ((mb_strlen($this->container['monetaryValue']) > 19)) {
            $invalidProperties[] = "invalid value for 'monetaryValue', the character length must be smaller than or equal to 19.";
        }

        if ((mb_strlen($this->container['monetaryValue']) < 1)) {
            $invalidProperties[] = "invalid value for 'monetaryValue', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['subType']) && (mb_strlen($this->container['subType']) > 50)) {
            $invalidProperties[] = "invalid value for 'subType', the character length must be smaller than or equal to 50.";
        }

        if (!is_null($this->container['subType']) && (mb_strlen($this->container['subType']) < 1)) {
     ...
     * Sets currencyCode
     *
     * @param string $currencyCode Itemized Charges currency code type. The currency code used in the Shipment request is returned.
     *
     * @return self
     */
    public function setCurrencyCode($currencyCode)
    {
        ...
        if ((mb_strlen($currencyCode) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling NegotiatedRateChargesItemizedCharges., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currencyCode) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling NegotiatedRateChargesItemizedCharges., must be bigger than or equal to 3.');
        }
    ...
    {
        return $this->container['monetaryValue'];
    }

    /**
     * Sets monetaryValue
     *
     * @param string $monetaryValue Itemized Charges value amount.  Valid values are from 0 to 99999999999999.99
     *
     * @return self
     */
    public function setMonetaryValue($monetaryValue)
    {
        if (is_null($monetaryValue)) {
            throw new \InvalidArgumentException('non-nullable monetaryValue cannot be null');
        }
        if ((mb_strlen($monetaryValue) > 19)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling NegotiatedRateChargesItemizedCharges., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($monetaryValue) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling NegotiatedRateChargesItemizedCharges., must be bigger than or equal to 1.');
        }

        $this->container['monetaryValue'] = $monetaryValue;
     ...
     * Sets subType
     *
     * @param string|null $subType The sub-type of ItemizedCharges type.
     *
     * @return self
     */
    public function setSubType($subType)
    {
        ...
        if ((mb_strlen($subType) > 50)) {
            throw new \InvalidArgumentException('invalid length for $subType when calling NegotiatedRateChargesItemizedCharges., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($subType) < 1)) {
            throw new \InvalidArgumentException('invalid length for $subType when calling NegotiatedRateChargesItemizedCharges., must be bigger than or equal to 1.');
        }
