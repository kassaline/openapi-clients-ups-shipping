...
class BillShipperCreditCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'securityCode' => 'string',
        'address' => '\OpenAPIClientUPSShipping\Model\CreditCardAddress'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('securityCode', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['expirationDate']) > 6)) {
            $invalidProperties[] = "invalid value for 'expirationDate', the character length must be smaller than or equal to 6.";
        }

        if ((mb_strlen($this->container['expirationDate']) < 6)) {
            $invalidProperties[] = "invalid value for 'expirationDate', the character length must be bigger than or equal to 6.";
        }

        if ($this->container['securityCode'] === null) {
            $invalidProperties[] = "'securityCode' can't be null";
        }
        if ((mb_strlen($this->container['securityCode']) > 4)) {
            $invalidProperties[] = "invalid value for 'securityCode', the character length must be smaller than or equal to 4.";
        }

        if ((mb_strlen($this->container['securityCode']) < 3)) {
     ...
     * Sets expirationDate
     *
     * @param string $expirationDate Format is MMYYYY where MM is the 2 digit month and YYYY is the 4 digit year.  Valid month values are 01-12 and valid year values are Present Year - (Present Year + 10 years)
     *
     * @return self
     */
    public function setExpirationDate($expirationDate)
    {
        ...
        if ((mb_strlen($expirationDate) > 6)) {
            throw new \InvalidArgumentException('invalid length for $expirationDate when calling BillShipperCreditCard., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($expirationDate) < 6)) {
            throw new \InvalidArgumentException('invalid length for $expirationDate when calling BillShipperCreditCard., must be bigger than or equal to 6.');
        }
    ...
    public function setSecurityCode($securityCode)
    {
        if (is_null($securityCode)) {
            throw new \InvalidArgumentException('non-nullable securityCode cannot be null');
        }
        if ((mb_strlen($securityCode) > 4)) {
            throw new \InvalidArgumentException('invalid length for $securityCode when calling BillShipperCreditCard., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($securityCode) < 3)) {
            throw new \InvalidArgumentException('invalid length for $securityCode when calling BillShipperCreditCard., must be bigger than or equal to 3.');
        }
     ...
     * Gets address
     *
     * @return \OpenAPIClientUPSShipping\Model\CreditCardAddress|null
     */
     ...
     * Sets address
     *
     * @param \OpenAPIClientUPSShipping\Model\CreditCardAddress|null $address address
     *
     * @return self
     */
