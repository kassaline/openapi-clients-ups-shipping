...
class PackageServiceOptionsDryIce implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'dryIceWeight' => '\OpenAPIClientUPSShipping\Model\DryIceDryIceWeight',
    ...
    protected static $attributeMap = [
        ...
        'medicalUseIndicator' => 'MedicalUseIndicator'
    ];
    ...
    protected static $setters = [
        ...
        'dryIceWeight' => 'setDryIceWeight',
        'medicalUseIndicator' => 'setMedicalUseIndicator'
    ];
    ...
    protected static $getters = [
        ...
        'medicalUseIndicator' => 'getMedicalUseIndicator'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('dryIceWeight', $data ?? [], null);
        $this->setIfExists('medicalUseIndicator', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['dryIceWeight'] === null) {
            $invalidProperties[] = "'dryIceWeight' can't be null";
        }
     ...
     * Sets regulationSet
     *
     * @param string $regulationSet Regulation set for dryIce Shipment. Valid values: CFR = HazMat regulated by US Dept. of Transportation within the U.S. or ground shipments to Canada, IATA= Worldwide Air movement.  The following values are valid: IATA, CFR.
     *
     * @return self
     */
    public function setRegulationSet($regulationSet)
    {
        ...
        if ((mb_strlen($regulationSet) > 4)) {
            throw new \InvalidArgumentException('invalid length for $regulationSet when calling PackageServiceOptionsDryIce., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($regulationSet) < 3)) {
            throw new \InvalidArgumentException('invalid length for $regulationSet when calling PackageServiceOptionsDryIce., must be bigger than or equal to 3.');
        }
     ...
     * Gets dryIceWeight
     *
     * @return \OpenAPIClientUPSShipping\Model\DryIceDryIceWeight
     */
    public function getDryIceWeight()
    {
        return $this->container['dryIceWeight'];
    }

    /**
     * Sets dryIceWeight
     *
     * @param \OpenAPIClientUPSShipping\Model\DryIceDryIceWeight $dryIceWeight dryIceWeight
     *
     * @return self
     */
    public function setDryIceWeight($dryIceWeight)
    {
        if (is_null($dryIceWeight)) {
            throw new \InvalidArgumentException('non-nullable dryIceWeight cannot be null');
        }
        $this->container['dryIceWeight'] = $dryIceWeight;

        return $this;
    }

    /**
     * Gets medicalUseIndicator
     *
     * @return string|null
     */
    public function getMedicalUseIndicator()
    {
        return $this->container['medicalUseIndicator'];
    }

    /**
     * Sets medicalUseIndicator
     *
     * @param string|null $medicalUseIndicator Presence/Absence Indicator. Any value inside is ignored. Relevant only in CFR regulation set. If present it is used to designate the dry Ice is for any medical use and rates are adjusted for DryIce weight more than 2.5 Kgs or 5.7 Lbs.
     *
     * @return self
     */
    public function setMedicalUseIndicator($medicalUseIndicator)
    {
        if (is_null($medicalUseIndicator)) {
            throw new \InvalidArgumentException('non-nullable medicalUseIndicator cannot be null');
        }


        $this->container['medicalUseIndicator'] = $medicalUseIndicator;
