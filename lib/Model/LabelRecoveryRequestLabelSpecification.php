...
class LabelRecoveryRequestLabelSpecification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'labelImageFormat' => '\OpenAPIClientUPSShipping\Model\LabelRecoveryLabelSpecificationLabelImageFormat',
        'labelStockSize' => '\OpenAPIClientUPSShipping\Model\LabelRecoveryLabelSpecificationLabelStockSize'
    ];
    ...
    */
     ...
     * Sets hTTPUserAgent
     *
     * @param string|null $hTTPUserAgent Browser HTTPUserAgent String. This is the preferred way of identifying GIF image type to be generated.  Required if <Root node>/ LabelSpecification/LabelImageFormat/Code = Gif. Default to Mozilla/4.5 if this field is missing or has invalid value.
     *
     * @return self
     */
    public function setHTTPUserAgent($hTTPUserAgent)
    {
        ...
        if ((mb_strlen($hTTPUserAgent) > 64)) {
            throw new \InvalidArgumentException('invalid length for $hTTPUserAgent when calling LabelRecoveryRequestLabelSpecification., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($hTTPUserAgent) < 1)) {
            throw new \InvalidArgumentException('invalid length for $hTTPUserAgent when calling LabelRecoveryRequestLabelSpecification., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \OpenAPIClientUPSShipping\Model\LabelRecoveryLabelSpecificationLabelImageFormat|null
     */
     ...
     *
     * @param \OpenAPIClientUPSShipping\Model\LabelRecoveryLabelSpecificationLabelImageFormat|null $labelImageFormat labelImageFormat
     *
     * @return self
     */
     ...
     * Gets labelStockSize
     *
     * @return \OpenAPIClientUPSShipping\Model\LabelRecoveryLabelSpecificationLabelStockSize|null
     */
     ...
     * Sets labelStockSize
     *
     * @param \OpenAPIClientUPSShipping\Model\LabelRecoveryLabelSpecificationLabelStockSize|null $labelStockSize labelStockSize
     *
     * @return self
     */
