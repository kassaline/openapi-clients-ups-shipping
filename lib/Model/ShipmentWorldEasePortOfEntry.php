 ...
 */
class ShipmentWorldEasePortOfEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Shipment_WorldEase_PortOfEntry';
    ...
    protected static $openAPITypes = [
        ...
        'consignee' => 'string',
        'address' => '\OpenAPIClientUPSShipping\Model\AddressPOE'
    ];
    ...
    protected static $attributeMap = [
        'name' => 'Name',
        'clearancePortCode' => 'ClearancePortCode',
        'consignee' => 'Consignee',
        'address' => 'Address'
    ];
    ...
    protected static $setters = [
        'name' => 'setName',
        'clearancePortCode' => 'setClearancePortCode',
    ...
    protected static $getters = [
        'name' => 'getName',
        'clearancePortCode' => 'getClearancePortCode',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('clearancePortCode', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['clearancePortCode'] === null) {
            $invalidProperties[] = "'clearancePortCode' can't be null";
        }
        if ($this->container['consignee'] === null) {
            $invalidProperties[] = "'consignee' can't be null";
        }
        if ((mb_strlen($this->container['consignee']) > 35)) {
            $invalidProperties[] = "invalid value for 'consignee', the character length must be smaller than or equal to 35.";
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ShipmentWorldEasePortOfEntry., must be smaller than or equal to 35.');
        }
    ...
    /**
     * Gets clearancePortCode
     *
     * @return string
     */
    public function getClearancePortCode()
    {
        return $this->container['clearancePortCode'];
    }

    /**
     * Sets clearancePortCode
     *
     * @param string $clearancePortCode Port code
     *
     * @return self
     */
    public function setClearancePortCode($clearancePortCode)
    {
        if (is_null($clearancePortCode)) {
            throw new \InvalidArgumentException('non-nullable clearancePortCode cannot be null');
        }
        $this->container['clearancePortCode'] = $clearancePortCode;
    ...
    public function setConsignee($consignee)
    {
        ...
        if ((mb_strlen($consignee) > 35)) {
            throw new \InvalidArgumentException('invalid length for $consignee when calling ShipmentWorldEasePortOfEntry., must be smaller than or equal to 35.');
        }
     ...
     * Gets address
     *
     * @return \OpenAPIClientUPSShipping\Model\AddressPOE
     */
     ...
     * Sets address
     *
     * @param \OpenAPIClientUPSShipping\Model\AddressPOE $address address
     *
     * @return self
     */
