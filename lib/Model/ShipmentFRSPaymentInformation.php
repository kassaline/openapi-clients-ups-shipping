...
class ShipmentFRSPaymentInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'type' => '\OpenAPIClientUPSShipping\Model\FRSPaymentInformationType',
        'accountNumber' => 'string',
        'address' => '\OpenAPIClientUPSShipping\Model\FRSPaymentInformationAddress'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['accountNumber']) > 6)) {
     ...
     * Gets type
     *
     * @return \OpenAPIClientUPSShipping\Model\FRSPaymentInformationType
     */
     ...
     * Sets type
     *
     * @param \OpenAPIClientUPSShipping\Model\FRSPaymentInformationType $type type
     *
     * @return self
     */
     ...
     * Sets accountNumber
     *
     * @param string $accountNumber The UPS account number.  If the Ground Freight Pricing indicator and FreightShipmentInformation/DensityEligibleIndicator is present in the request, this account number must be validated to check if it is Ground Freight Pricing Density Based Rating enabled.
     *
     * @return self
     */
    public function setAccountNumber($accountNumber)
    {
        ...
        if ((mb_strlen($accountNumber) > 6)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling ShipmentFRSPaymentInformation., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($accountNumber) < 6)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling ShipmentFRSPaymentInformation., must be bigger than or equal to 6.');
        }
     ...
     * Gets address
     *
     * @return \OpenAPIClientUPSShipping\Model\FRSPaymentInformationAddress|null
     */
     ...
     * Sets address
     *
     * @param \OpenAPIClientUPSShipping\Model\FRSPaymentInformationAddress|null $address address
     *
     * @return self
     */
