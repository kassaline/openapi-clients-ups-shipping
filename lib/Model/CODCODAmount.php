    ...
    */
    ...
    public function setCurrencyCode($currencyCode)
    {
        ...
        if ((mb_strlen($currencyCode) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling CODCODAmount., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currencyCode) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling CODCODAmount., must be bigger than or equal to 3.');
        }
     ...
     * Sets monetaryValue
     *
     * @param string $monetaryValue COD Amount monetary value.
     *
     * @return self
     */
    public function setMonetaryValue($monetaryValue)
    {
        ...
        if ((mb_strlen($monetaryValue) > 5)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling CODCODAmount., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($monetaryValue) < 5)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling CODCODAmount., must be bigger than or equal to 5.');
        }
