...
class InternationalFormsEEIFilingOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'eMailAddress' => 'string',
        'description' => 'string',
        'uPSFiled' => '\OpenAPIClientUPSShipping\Model\EEIFilingOptionUPSFiled',
        'shipperFiled' => '\OpenAPIClientUPSShipping\Model\EEIFilingOptionShipperFiled'
    ];
    ...
    protected static $setters = [
        ...
        'uPSFiled' => 'setUPSFiled',
        'shipperFiled' => 'setShipperFiled'
    ];
    ...
    protected static $getters = [
        ...
        'uPSFiled' => 'getUPSFiled',
        'shipperFiled' => 'getShipperFiled'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('uPSFiled', $data ?? [], null);
        $this->setIfExists('shipperFiled', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets eMailAddress
     *
     * @param string|null $eMailAddress Email Address where the notification is sent. Valid for UPS filed (option 3), Shipper filed (option 1- A , 1-C)  Applicable for EEI form.
     *
     * @return self
     */
    public function setEMailAddress($eMailAddress)
    {
        ...
        if ((mb_strlen($eMailAddress) > 50)) {
            throw new \InvalidArgumentException('invalid length for $eMailAddress when calling InternationalFormsEEIFilingOption., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($eMailAddress) < 1)) {
            throw new \InvalidArgumentException('invalid length for $eMailAddress when calling InternationalFormsEEIFilingOption., must be bigger than or equal to 1.');
        }
     ...
     * Gets uPSFiled
     *
     * @return \OpenAPIClientUPSShipping\Model\EEIFilingOptionUPSFiled|null
     */
    public function getUPSFiled()
    {
        return $this->container['uPSFiled'];
    }

    /**
     * Sets uPSFiled
     *
     * @param \OpenAPIClientUPSShipping\Model\EEIFilingOptionUPSFiled|null $uPSFiled uPSFiled
     *
     * @return self
     */
    ...
    {
        if (is_null($uPSFiled)) {
            throw new \InvalidArgumentException('non-nullable uPSFiled cannot be null');
        }
        $this->container['uPSFiled'] = $uPSFiled;
     ...
     * Gets shipperFiled
     *
     * @return \OpenAPIClientUPSShipping\Model\EEIFilingOptionShipperFiled|null
     */
    public function getShipperFiled()
    {
        return $this->container['shipperFiled'];
    }

    /**
     * Sets shipperFiled
     *
     * @param \OpenAPIClientUPSShipping\Model\EEIFilingOptionShipperFiled|null $shipperFiled shipperFiled
     *
     * @return self
     */
    public function setShipperFiled($shipperFiled)
    {
        if (is_null($shipperFiled)) {
            throw new \InvalidArgumentException('non-nullable shipperFiled cannot be null');
        }
        $this->container['shipperFiled'] = $shipperFiled;
