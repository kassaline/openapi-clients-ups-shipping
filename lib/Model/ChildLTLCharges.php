...
/**
 * ChildLTLCharges Class Doc Comment
 *
 * @category Class
 * @description Represents transportation charges for child shipments categorized as \&quot;Less than Truck Load\&quot; (LTL), including freight, fuel surcharges, and accessorial fees. These charges are calculated based on shipment weight, volume, or distance. Applicable only for LTL child.
 * @package  OpenAPIClientUPSShipping
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ChildLTLCharges implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Child_LTL_Charges';
    ...
    protected static $openAPITypes = [
        ...
        'otherCharges' => '\OpenAPIClientUPSShipping\Model\LTLOtherCharges'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['discount']) && !preg_match("/^[0-9]+(\\.[0-9]{1,2})?$/", $this->container['discount'])) {
            $invalidProperties[] = "invalid value for 'discount', must be conform to the pattern /^[0-9]+(\\.[0-9]{1,2})?$/.";
        }

        if (!is_null($this->container['freightCharges']) && !preg_match("/^[0-9]+(\\.[0-9]{1,2})?$/", $this->container['freightCharges'])) {
            $invalidProperties[] = "invalid value for 'freightCharges', must be conform to the pattern /^[0-9]+(\\.[0-9]{1,2})?$/.";
        }

        if (!is_null($this->container['insuranceCharges']) && !preg_match("/^[0-9]+(\\.[0-9]{1,2})?$/", $this->container['insuranceCharges'])) {
            $invalidProperties[] = "invalid value for 'insuranceCharges', must be conform to the pattern /^[0-9]+(\\.[0-9]{1,2})?$/.";
        }
     ...
     * Sets discount
     *
     * @param string|null $discount The monetary value of the discount/rebate charge.
     *
     * @return self
     */
    public function setDiscount($discount)
    {
        ...
        if ((!preg_match("/^[0-9]+(\\.[0-9]{1,2})?$/", ObjectSerializer::toString($discount)))) {
            throw new \InvalidArgumentException("invalid value for \$discount when calling ChildLTLCharges., must conform to the pattern /^[0-9]+(\\.[0-9]{1,2})?$/.");
        }
     ...
     * Sets freightCharges
     *
     * @param string|null $freightCharges Freight charges.
     *
     * @return self
     */
    public function setFreightCharges($freightCharges)
    {
        ...
        if ((!preg_match("/^[0-9]+(\\.[0-9]{1,2})?$/", ObjectSerializer::toString($freightCharges)))) {
            throw new \InvalidArgumentException("invalid value for \$freightCharges when calling ChildLTLCharges., must conform to the pattern /^[0-9]+(\\.[0-9]{1,2})?$/.");
        }
     ...
     *
     * @param string|null $insuranceCharges The monetary value of the insurance charge.
     *
     * @return self
     */
    public function setInsuranceCharges($insuranceCharges)
    {
        ...
        if ((!preg_match("/^[0-9]+(\\.[0-9]{1,2})?$/", ObjectSerializer::toString($insuranceCharges)))) {
            throw new \InvalidArgumentException("invalid value for \$insuranceCharges when calling ChildLTLCharges., must conform to the pattern /^[0-9]+(\\.[0-9]{1,2})?$/.");
        }
     ...
     * Gets otherCharges
     *
     * @return \OpenAPIClientUPSShipping\Model\LTLOtherCharges|null
     */
     ...
     * Sets otherCharges
     *
     * @param \OpenAPIClientUPSShipping\Model\LTLOtherCharges|null $otherCharges otherCharges
     *
     * @return self
     */
