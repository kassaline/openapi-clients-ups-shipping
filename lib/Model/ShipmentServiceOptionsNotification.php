...
class ShipmentServiceOptionsNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'eMail' => '\OpenAPIClientUPSShipping\Model\NotificationEMail',
        'voiceMessage' => '\OpenAPIClientUPSShipping\Model\NotificationVoiceMessage',
        'textMessage' => '\OpenAPIClientUPSShipping\Model\NotificationTextMessage',
        'locale' => '\OpenAPIClientUPSShipping\Model\NotificationLocale'
    ];
    ...
    {
        $this->setIfExists('notificationCode', $data ?? [], null);
        $this->setIfExists('eMail', $data ?? [], null);
        $this->setIfExists('voiceMessage', $data ?? [], null);
        $this->setIfExists('textMessage', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['notificationCode'] === null) {
            $invalidProperties[] = "'notificationCode' can't be null";
        }
        if ((mb_strlen($this->container['notificationCode']) > 1)) {
            $invalidProperties[] = "invalid value for 'notificationCode', the character length must be smaller than or equal to 1.";
        }

        if ((mb_strlen($this->container['notificationCode']) < 1)) {
            $invalidProperties[] = "invalid value for 'notificationCode', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setNotificationCode($notificationCode)
    {
        if (is_null($notificationCode)) {
            throw new \InvalidArgumentException('non-nullable notificationCode cannot be null');
        }
        if ((mb_strlen($notificationCode) > 1)) {
            throw new \InvalidArgumentException('invalid length for $notificationCode when calling ShipmentServiceOptionsNotification., must be smaller than or equal to 1.');
        }
        if ((mb_strlen($notificationCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $notificationCode when calling ShipmentServiceOptionsNotification., must be bigger than or equal to 1.');
        }

        $this->container['notificationCode'] = $notificationCode;
     ...
     * Gets eMail
     *
     * @return \OpenAPIClientUPSShipping\Model\NotificationEMail
     */
     ...
     * Sets eMail
     *
     * @param \OpenAPIClientUPSShipping\Model\NotificationEMail $eMail eMail
     *
     * @return self
     */
     ...
     * Gets voiceMessage
     *
     * @return \OpenAPIClientUPSShipping\Model\NotificationVoiceMessage|null
     */
    public function getVoiceMessage()
    {
        return $this->container['voiceMessage'];
    }

    /**
     * Sets voiceMessage
     *
     * @param \OpenAPIClientUPSShipping\Model\NotificationVoiceMessage|null $voiceMessage voiceMessage
     *
     * @return self
     */
    public function setVoiceMessage($voiceMessage)
    {
        if (is_null($voiceMessage)) {
            throw new \InvalidArgumentException('non-nullable voiceMessage cannot be null');
        }
        $this->container['voiceMessage'] = $voiceMessage;
     ...
     * Gets textMessage
     *
     * @return \OpenAPIClientUPSShipping\Model\NotificationTextMessage|null
     */
    public function getTextMessage()
    {
        return $this->container['textMessage'];
    }

    /**
     * Sets textMessage
     *
     * @param \OpenAPIClientUPSShipping\Model\NotificationTextMessage|null $textMessage textMessage
     *
     * @return self
     */
    public function setTextMessage($textMessage)
    {
        if (is_null($textMessage)) {
            throw new \InvalidArgumentException('non-nullable textMessage cannot be null');
        }
        $this->container['textMessage'] = $textMessage;
     ...
     * Gets locale
     *
     * @return \OpenAPIClientUPSShipping\Model\NotificationLocale|null
     */
     ...
     * Sets locale
     *
     * @param \OpenAPIClientUPSShipping\Model\NotificationLocale|null $locale locale
     *
     * @return self
     */
