...
class ContactsForwardAgent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'address' => '\OpenAPIClientUPSShipping\Model\ForwardAgentAddress'
    ];
    ...
    */
     ...
     * Sets companyName
     *
     * @param string $companyName Company Name or the Individual name of the Forwarding agent.  Applicable for EEI form only.
     *
     * @return self
     */
    public function setCompanyName($companyName)
    {
        ...
        if ((mb_strlen($companyName) > 35)) {
            throw new \InvalidArgumentException('invalid length for $companyName when calling ContactsForwardAgent., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($companyName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $companyName when calling ContactsForwardAgent., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string $taxIdentificationNumber Tax ID of the Forwarding agent. Valid Values: (Below values are applicable for EEIFilingOption Code =3) 94-308351500  13-168669100     Applicable for EEI form only.
     *
     * @return self
     */
    public function setTaxIdentificationNumber($taxIdentificationNumber)
    {
        ...
        if ((mb_strlen($taxIdentificationNumber) > 15)) {
            throw new \InvalidArgumentException('invalid length for $taxIdentificationNumber when calling ContactsForwardAgent., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($taxIdentificationNumber) < 1)) {
            throw new \InvalidArgumentException('invalid length for $taxIdentificationNumber when calling ContactsForwardAgent., must be bigger than or equal to 1.');
        }
     ...
     * Gets address
     *
     * @return \OpenAPIClientUPSShipping\Model\ForwardAgentAddress
     */
     ...
     * Sets address
     *
     * @param \OpenAPIClientUPSShipping\Model\ForwardAgentAddress $address address
     *
     * @return self
     */
