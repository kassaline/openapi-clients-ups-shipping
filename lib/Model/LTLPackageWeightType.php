...
/**
 * LTLPackageWeightType Class Doc Comment
 *
 * @category Class
 ...
 */
class LTLPackageWeightType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LTL_Package_Weight_Type';
    ...
    public const UNIT_OF_MEASUREMENT_KGS = 'KGS';
    ...
    */
     ...
     * Sets weight
     *
     * @param string $weight Weight of the package/ltl.
     *
     * @return self
     */
     ...
     *
     * @param string $unitOfMeasurement Unit of measurement of the weight.  Valid values are:  - KGS = Kilograms - LBS =Pounds
     *
     * @return self
     */
