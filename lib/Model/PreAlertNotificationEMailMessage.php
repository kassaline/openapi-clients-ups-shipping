...
class PreAlertNotificationEMailMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets eMailAddress
     *
     * @param string $eMailAddress EMailAddress where PreAlertNotification is sent.
     *
     * @return self
     */
    public function setEMailAddress($eMailAddress)
    {
        ...
        if ((mb_strlen($eMailAddress) > 50)) {
            throw new \InvalidArgumentException('invalid length for $eMailAddress when calling PreAlertNotificationEMailMessage., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($eMailAddress) < 1)) {
            throw new \InvalidArgumentException('invalid length for $eMailAddress when calling PreAlertNotificationEMailMessage., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $undeliverableEMailAddress This is used for notification when EMailAddress for PreAlertNotification is undeliverable.
     *
     * @return self
     */
    public function setUndeliverableEMailAddress($undeliverableEMailAddress)
    {
        ...
        if ((mb_strlen($undeliverableEMailAddress) > 50)) {
            throw new \InvalidArgumentException('invalid length for $undeliverableEMailAddress when calling PreAlertNotificationEMailMessage., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($undeliverableEMailAddress) < 1)) {
            throw new \InvalidArgumentException('invalid length for $undeliverableEMailAddress when calling PreAlertNotificationEMailMessage., must be bigger than or equal to 1.');
        }
