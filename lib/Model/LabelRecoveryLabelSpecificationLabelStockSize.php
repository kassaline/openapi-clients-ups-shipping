 ...
 */
class LabelRecoveryLabelSpecificationLabelStockSize implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LabelRecovery_LabelSpecification_LabelStockSize';
    ...
    */
    ...
    public function setHeight($height)
    {
        ...
        if ((mb_strlen($height) > 3)) {
            throw new \InvalidArgumentException('invalid length for $height when calling LabelRecoveryLabelSpecificationLabelStockSize., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($height) < 1)) {
            throw new \InvalidArgumentException('invalid length for $height when calling LabelRecoveryLabelSpecificationLabelStockSize., must be bigger than or equal to 1.');
        }
    ...
    public function setWidth($width)
    {
        ...
        if ((mb_strlen($width) > 3)) {
            throw new \InvalidArgumentException('invalid length for $width when calling LabelRecoveryLabelSpecificationLabelStockSize., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($width) < 1)) {
            throw new \InvalidArgumentException('invalid length for $width when calling LabelRecoveryLabelSpecificationLabelStockSize., must be bigger than or equal to 1.');
        }
