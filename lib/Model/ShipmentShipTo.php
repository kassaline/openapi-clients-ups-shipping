...
class ShipmentShipTo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'phone' => '\OpenAPIClientUPSShipping\Model\ShipToPhone',
        'faxNumber' => 'string',
        'eMailAddress' => 'string',
        'address' => '\OpenAPIClientUPSShipping\Model\ShipToAddress',
        'locationID' => 'string'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['faxNumber']) && (mb_strlen($this->container['faxNumber']) > 15)) {
            $invalidProperties[] = "invalid value for 'faxNumber', the character length must be smaller than or equal to 15.";
        }
        ...
        if (!is_null($this->container['locationID']) && (mb_strlen($this->container['locationID']) > 10)) {
            $invalidProperties[] = "invalid value for 'locationID', the character length must be smaller than or equal to 10.";
        }

        if (!is_null($this->container['locationID']) && (mb_strlen($this->container['locationID']) < 3)) {
            $invalidProperties[] = "invalid value for 'locationID', the character length must be bigger than or equal to 3.";
        }
     ...
     * Sets attentionName
     *
     * @param string|null $attentionName Contact name at the consignee's location.  Required for: UPS Next Day Air® Early service, and when ShipTo country or territory is different than ShipFrom country or territory.  Required if Invoice International form is requested.
     *
     * @return self
     */
    public function setAttentionName($attentionName)
    {
        ...
        if ((mb_strlen($attentionName) > 35)) {
            throw new \InvalidArgumentException('invalid length for $attentionName when calling ShipmentShipTo., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($attentionName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $attentionName when calling ShipmentShipTo., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $companyDisplayableName Not applicable for ShipTo
     *
     * @return self
     */
    public function setCompanyDisplayableName($companyDisplayableName)
    {
        ...
        if ((mb_strlen($companyDisplayableName) > 35)) {
            throw new \InvalidArgumentException('invalid length for $companyDisplayableName when calling ShipmentShipTo., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($companyDisplayableName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $companyDisplayableName when calling ShipmentShipTo., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $taxIdentificationNumber Consignee's tax identification number. This element has been deprecated, replacement can be found in the GlobalTaxInformation container.
     *
     * @return self
     * @deprecated
     */
    public function setTaxIdentificationNumber($taxIdentificationNumber)
    {
        ...
        if ((mb_strlen($taxIdentificationNumber) > 15)) {
            throw new \InvalidArgumentException('invalid length for $taxIdentificationNumber when calling ShipmentShipTo., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($taxIdentificationNumber) < 1)) {
            throw new \InvalidArgumentException('invalid length for $taxIdentificationNumber when calling ShipmentShipTo., must be bigger than or equal to 1.');
        }
     ...
     * Gets phone
     *
     * @return \OpenAPIClientUPSShipping\Model\ShipToPhone|null
     */
     ...
     * Sets phone
     *
     * @param \OpenAPIClientUPSShipping\Model\ShipToPhone|null $phone phone
     *
     * @return self
     */
     ...
     * Sets faxNumber
     *
     * @param string|null $faxNumber Consignee's fax number.  If ShipTo country or territory is US 10 digits allowed, otherwise 1-15 digits allowed.
     *
     * @return self
     */
    public function setFaxNumber($faxNumber)
    {
        ...
        if ((mb_strlen($faxNumber) > 15)) {
            throw new \InvalidArgumentException('invalid length for $faxNumber when calling ShipmentShipTo., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($faxNumber) < 1)) {
            throw new \InvalidArgumentException('invalid length for $faxNumber when calling ShipmentShipTo., must be bigger than or equal to 1.');
        }
     ...
     * Sets eMailAddress
     *
     * @param string|null $eMailAddress Consignee's email address.
     *
     * @return self
     */
    public function setEMailAddress($eMailAddress)
    {
        ...
        if ((mb_strlen($eMailAddress) > 50)) {
            throw new \InvalidArgumentException('invalid length for $eMailAddress when calling ShipmentShipTo., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($eMailAddress) < 1)) {
            throw new \InvalidArgumentException('invalid length for $eMailAddress when calling ShipmentShipTo., must be bigger than or equal to 1.');
        }
     ...
     * Gets address
     *
     * @return \OpenAPIClientUPSShipping\Model\ShipToAddress
     */
     ...
     * Sets address
     *
     * @param \OpenAPIClientUPSShipping\Model\ShipToAddress $address address
     *
     * @return self
     */
     ...
     * Sets locationID
     *
     * @param string|null $locationID Location ID is a unique identifier referring to a specific shipping/receiving location.  Location ID must be alphanumeric characters. All letters must be capitalized.
     *
     * @return self
     */
    public function setLocationID($locationID)
    {
        ...
        if ((mb_strlen($locationID) > 10)) {
            throw new \InvalidArgumentException('invalid length for $locationID when calling ShipmentShipTo., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($locationID) < 3)) {
            throw new \InvalidArgumentException('invalid length for $locationID when calling ShipmentShipTo., must be bigger than or equal to 3.');
        }
