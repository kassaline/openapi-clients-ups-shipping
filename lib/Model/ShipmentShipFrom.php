 ...
 *
 * @category Class
 * @description Ship From Container.  Required for return shipment.   Required if pickup location is different from the shipper&#39;s address.   Required for Trade Direct shipment.
 * @package  OpenAPIClientUPSShipping
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class ShipmentShipFrom implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'taxIDType' => '\OpenAPIClientUPSShipping\Model\ShipFromTaxIDType',
        'phone' => '\OpenAPIClientUPSShipping\Model\ShipFromPhone',
        'faxNumber' => 'string',
        'address' => '\OpenAPIClientUPSShipping\Model\ShipFromAddress',
        'vendorInfo' => '\OpenAPIClientUPSShipping\Model\ShipFromVendorInfo'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('taxIDType', $data ?? [], null);
        $this->setIfExists('phone', $data ?? [], null);
        $this->setIfExists('faxNumber', $data ?? [], null);
        $this->setIfExists('address', $data ?? [], null);
        $this->setIfExists('vendorInfo', $data ?? [], null);
    }
    ...
    */
    ...
    public function setAttentionName($attentionName)
    {
        ...
        if ((mb_strlen($attentionName) > 35)) {
            throw new \InvalidArgumentException('invalid length for $attentionName when calling ShipmentShipFrom., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($attentionName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $attentionName when calling ShipmentShipFrom., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $companyDisplayableName Not applicable for ShipFrom.
     *
     * @return self
     */
    public function setCompanyDisplayableName($companyDisplayableName)
    {
        ...
        if ((mb_strlen($companyDisplayableName) > 35)) {
            throw new \InvalidArgumentException('invalid length for $companyDisplayableName when calling ShipmentShipFrom., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($companyDisplayableName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $companyDisplayableName when calling ShipmentShipFrom., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $taxIdentificationNumber Company's Tax Identification Number at the pick up location.  Conditionally required if EEI form (International forms) is requested.  Applies to EEI Form only. This element has been deprecated, replacement can be found in the GlobalTaxInformation container.
     *
     * @return self
     * @deprecated
     */
    public function setTaxIdentificationNumber($taxIdentificationNumber)
    {
        ...
        if ((mb_strlen($taxIdentificationNumber) > 15)) {
            throw new \InvalidArgumentException('invalid length for $taxIdentificationNumber when calling ShipmentShipFrom., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($taxIdentificationNumber) < 1)) {
            throw new \InvalidArgumentException('invalid length for $taxIdentificationNumber when calling ShipmentShipFrom., must be bigger than or equal to 1.');
        }
     ...
     * Gets taxIDType
     *
     * @return \OpenAPIClientUPSShipping\Model\ShipFromTaxIDType|null
     */
    public function getTaxIDType()
    {
        return $this->container['taxIDType'];
    }

    /**
     * Sets taxIDType
     *
     * @param \OpenAPIClientUPSShipping\Model\ShipFromTaxIDType|null $taxIDType taxIDType
     *
     * @return self
     */
    public function setTaxIDType($taxIDType)
    {
        if (is_null($taxIDType)) {
            throw new \InvalidArgumentException('non-nullable taxIDType cannot be null');
        }
        $this->container['taxIDType'] = $taxIDType;
     ...
     * Gets phone
     *
     * @return \OpenAPIClientUPSShipping\Model\ShipFromPhone|null
     */
     ...
     * Sets phone
     *
     * @param \OpenAPIClientUPSShipping\Model\ShipFromPhone|null $phone phone
     *
     * @return self
     */
     ...
     * Sets faxNumber
     *
     * @param string|null $faxNumber The Ship from fax number.  If Ship from country or territory is US 10 digits allowed, otherwise 1-15 digits allowed.
     *
     * @return self
     */
    public function setFaxNumber($faxNumber)
    {
        ...
        if ((mb_strlen($faxNumber) > 15)) {
            throw new \InvalidArgumentException('invalid length for $faxNumber when calling ShipmentShipFrom., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($faxNumber) < 1)) {
            throw new \InvalidArgumentException('invalid length for $faxNumber when calling ShipmentShipFrom., must be bigger than or equal to 1.');
        }
     ...
     * Gets address
     *
     * @return \OpenAPIClientUPSShipping\Model\ShipFromAddress
     */
     ...
     * Sets address
     *
     * @param \OpenAPIClientUPSShipping\Model\ShipFromAddress $address address
     *
     * @return self
     */
     ...
     * Gets vendorInfo
     *
     * @return \OpenAPIClientUPSShipping\Model\ShipFromVendorInfo|null
     */
    public function getVendorInfo()
    {
        return $this->container['vendorInfo'];
    }

    /**
     * Sets vendorInfo
     *
     * @param \OpenAPIClientUPSShipping\Model\ShipFromVendorInfo|null $vendorInfo vendorInfo
     *
     * @return self
     */
    public function setVendorInfo($vendorInfo)
    {
        if (is_null($vendorInfo)) {
            throw new \InvalidArgumentException('non-nullable vendorInfo cannot be null');
        }
        $this->container['vendorInfo'] = $vendorInfo;
