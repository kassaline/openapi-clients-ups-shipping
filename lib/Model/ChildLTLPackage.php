...
/**
 * ChildLTLPackage Class Doc Comment
 *
 * @category Class
 * @description LTL package information. Applicable only for LTL child.
 * @package  OpenAPIClientUPSShipping
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ChildLTLPackage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Child_LTL_Package';
    ...
    protected static $openAPITypes = [
        ...
        'handlingUnits' => '\OpenAPIClientUPSShipping\Model\LTLHandlingUnits',
        'referenceNumber' => '\OpenAPIClientUPSShipping\Model\LTLReferenceNumber'
    ];
    ...
    protected static $setters = [
        'numberOfIdenticalUnits' => 'setNumberOfIdenticalUnits',
    ...
    protected static $getters = [
        'numberOfIdenticalUnits' => 'getNumberOfIdenticalUnits',
        'handlingUnits' => 'getHandlingUnits',
    ...
    {
        $this->setIfExists('numberOfIdenticalUnits', $data ?? [], null);
        $this->setIfExists('handlingUnits', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['numberOfIdenticalUnits'] === null) {
            $invalidProperties[] = "'numberOfIdenticalUnits' can't be null";
        }
        if ($this->container['handlingUnits'] === null) {
            $invalidProperties[] = "'handlingUnits' can't be null";
        }
    ...
    /**
     * Gets numberOfIdenticalUnits
     *
     * @return string
     */
    public function getNumberOfIdenticalUnits()
    {
        return $this->container['numberOfIdenticalUnits'];
    }

    /**
     * Sets numberOfIdenticalUnits
     *
     * @param string $numberOfIdenticalUnits Number of identical units in the package/ltl.
     *
     * @return self
     */
    public function setNumberOfIdenticalUnits($numberOfIdenticalUnits)
    {
        if (is_null($numberOfIdenticalUnits)) {
            throw new \InvalidArgumentException('non-nullable numberOfIdenticalUnits cannot be null');
        }


        $this->container['numberOfIdenticalUnits'] = $numberOfIdenticalUnits;
     ...
     * Gets handlingUnits
     *
     * @return \OpenAPIClientUPSShipping\Model\LTLHandlingUnits
     */
    public function getHandlingUnits()
    {
        return $this->container['handlingUnits'];
    }

    /**
     * Sets handlingUnits
     *
     * @param \OpenAPIClientUPSShipping\Model\LTLHandlingUnits $handlingUnits handlingUnits
     *
     * @return self
     */
    public function setHandlingUnits($handlingUnits)
    {
        if (is_null($handlingUnits)) {
            throw new \InvalidArgumentException('non-nullable handlingUnits cannot be null');
        }
        $this->container['handlingUnits'] = $handlingUnits;
     ...
     *
     * @return \OpenAPIClientUPSShipping\Model\LTLReferenceNumber|null
     */
     ...
     *
     * @param \OpenAPIClientUPSShipping\Model\LTLReferenceNumber|null $referenceNumber referenceNumber
     *
     * @return self
     */
