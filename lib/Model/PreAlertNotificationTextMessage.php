    ...
    */
    ...
    public function setPhoneNumber($phoneNumber)
    {
        ...
        if ((mb_strlen($phoneNumber) > 15)) {
            throw new \InvalidArgumentException('invalid length for $phoneNumber when calling PreAlertNotificationTextMessage., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($phoneNumber) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phoneNumber when calling PreAlertNotificationTextMessage., must be bigger than or equal to 1.');
        }
