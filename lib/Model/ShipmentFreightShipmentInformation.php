...
class ShipmentFreightShipmentInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'freightDensityInfo' => '\OpenAPIClientUPSShipping\Model\FreightShipmentInformationFreightDensityInfo',
    ...
    protected static $openAPIFormats = [
        'freightDensityInfo' => null,
        'densityEligibleIndicator' => null
    ];
    ...
    protected static array $openAPINullables = [
        'freightDensityInfo' => false,
        'densityEligibleIndicator' => false
    ];
    ...
    protected static $setters = [
        'freightDensityInfo' => 'setFreightDensityInfo',
        'densityEligibleIndicator' => 'setDensityEligibleIndicator'
    ];
    ...
    protected static $getters = [
        'freightDensityInfo' => 'getFreightDensityInfo',
        'densityEligibleIndicator' => 'getDensityEligibleIndicator'
    ];
    ...
    {
        $this->setIfExists('freightDensityInfo', $data ?? [], null);
        $this->setIfExists('densityEligibleIndicator', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets freightDensityInfo
     *
     * @return \OpenAPIClientUPSShipping\Model\FreightShipmentInformationFreightDensityInfo|null
     */
    public function getFreightDensityInfo()
    {
        return $this->container['freightDensityInfo'];
    }

    /**
     * Sets freightDensityInfo
     *
     * @param \OpenAPIClientUPSShipping\Model\FreightShipmentInformationFreightDensityInfo|null $freightDensityInfo freightDensityInfo
     *
     * @return self
     */
    public function setFreightDensityInfo($freightDensityInfo)
    {
        if (is_null($freightDensityInfo)) {
            throw new \InvalidArgumentException('non-nullable freightDensityInfo cannot be null');
        }
        $this->container['freightDensityInfo'] = $freightDensityInfo;

        return $this;
    }

    /**
     * Gets densityEligibleIndicator
     *
     * @return string|null
     */
    public function getDensityEligibleIndicator()
    {
        return $this->container['densityEligibleIndicator'];
    }

    /**
     * Sets densityEligibleIndicator
     *
     * @param string|null $densityEligibleIndicator The presence of the tag indicates that the rate request is density based. For Density Based Rating (DBR), the customer must have DBR Contract Service.
     *
     * @return self
     */
    public function setDensityEligibleIndicator($densityEligibleIndicator)
    {
        if (is_null($densityEligibleIndicator)) {
            throw new \InvalidArgumentException('non-nullable densityEligibleIndicator cannot be null');
        }


        $this->container['densityEligibleIndicator'] = $densityEligibleIndicator;
