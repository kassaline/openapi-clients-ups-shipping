    ...
    */
    ...
    public function setCustomerContext($customerContext)
    {
        ...
        if ((mb_strlen($customerContext) > 512)) {
            throw new \InvalidArgumentException('invalid length for $customerContext when calling ResponseTransactionReference., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($customerContext) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerContext when calling ResponseTransactionReference., must be bigger than or equal to 1.');
        }
