...
/**
 * LTLReferenceNumber Class Doc Comment
 *
 * @category Class
 * @description LTL Reference number.
 * @package  OpenAPIClientUPSShipping
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class LTLReferenceNumber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LTL_Reference_Number';
    ...
    public const CODE_PO = 'PO';
    public const CODE_REF = 'REF';
    public const CODE_INV = 'INV';
    ...
    */
     ...
     * Sets code
     *
     * @param string $code Reference number code supplied by customer.  Valid values are:  - PO = Purchase Order Number - REF =Reference Number - INV = Invoice Number
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string $value Reference number supplied by customer.
     *
     * @return self
     */
