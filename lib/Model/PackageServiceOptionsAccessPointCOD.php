    ...
    */
    ...
    public function setCurrencyCode($currencyCode)
    {
        ...
        if ((mb_strlen($currencyCode) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling PackageServiceOptionsAccessPointCOD., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currencyCode) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling PackageServiceOptionsAccessPointCOD., must be bigger than or equal to 3.');
        }
    ...
    public function setMonetaryValue($monetaryValue)
    {
        ...
        if ((mb_strlen($monetaryValue) > 8)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling PackageServiceOptionsAccessPointCOD., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($monetaryValue) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling PackageServiceOptionsAccessPointCOD., must be bigger than or equal to 1.');
        }
