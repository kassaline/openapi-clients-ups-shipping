 ...
 */
class GlobalTaxInformationAgentTaxIdentificationNumber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GlobalTaxInformation_AgentTaxIdentificationNumber';
    ...
    protected static $openAPITypes = [
        'agentRole' => 'string',
        'taxIdentificationNumber' => '\OpenAPIClientUPSShipping\Model\AgentTaxIdentificationNumberTaxIdentificationNumber'
    ];
    ...
    {
        $this->setIfExists('agentRole', $data ?? [], null);
    ...
    */
     ...
     * Sets agentRole
     *
     * @param string $agentRole (SHIP_FROM=20, CONSIGNEE=30)
     *
     * @return self
     */
    public function setAgentRole($agentRole)
    {
        if (is_null($agentRole)) {
            throw new \InvalidArgumentException('non-nullable agentRole cannot be null');
        }
     ...
     *
     * @return \OpenAPIClientUPSShipping\Model\AgentTaxIdentificationNumberTaxIdentificationNumber|null
     */
     ...
     *
     * @param \OpenAPIClientUPSShipping\Model\AgentTaxIdentificationNumberTaxIdentificationNumber|null $taxIdentificationNumber taxIdentificationNumber
     *
     * @return self
     */
