...
class ShipmentResultsForm implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'code' => 'string',
        'description' => 'string',
        'image' => '\OpenAPIClientUPSShipping\Model\ShipmentResultsFormImage',
        'formGroupId' => 'string',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('formGroupId', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['formGroupId']) && (mb_strlen($this->container['formGroupId']) > 26)) {
            $invalidProperties[] = "invalid value for 'formGroupId', the character length must be smaller than or equal to 26.";
        }

        if (!is_null($this->container['formGroupId']) && (mb_strlen($this->container['formGroupId']) < 1)) {
            $invalidProperties[] = "invalid value for 'formGroupId', the character length must be bigger than or equal to 1.";
        }
     ...
     * Sets code
     *
     * @param string|null $code Code that indicates the type of form.  Valid values: 01 - All Requested International Forms.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description that indicates the type of form. Possible Values. All Requested International Forms.
     *
     * @return self
     */
     ...
     * Gets image
     *
     * @return \OpenAPIClientUPSShipping\Model\ShipmentResultsFormImage|null
     */
     ...
     * Sets image
     *
     * @param \OpenAPIClientUPSShipping\Model\ShipmentResultsFormImage|null $image image
     *
     * @return self
     */
    ...
    {
        return $this->container['formGroupId'];
    }

    /**
     * Sets formGroupId
     *
     * @param string|null $formGroupId Unique Id for later retrieval of saved version of the completed international forms. Always returned when code = 01. 01 represents international forms.
     *
     * @return self
     */
    public function setFormGroupId($formGroupId)
    {
        if (is_null($formGroupId)) {
            throw new \InvalidArgumentException('non-nullable formGroupId cannot be null');
        }
        if ((mb_strlen($formGroupId) > 26)) {
            throw new \InvalidArgumentException('invalid length for $formGroupId when calling ShipmentResultsForm., must be smaller than or equal to 26.');
        }
        if ((mb_strlen($formGroupId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $formGroupId when calling ShipmentResultsForm., must be bigger than or equal to 1.');
        }

        $this->container['formGroupId'] = $formGroupId;
     ...
     *
     * @param string|null $formGroupIdName Contains description text which identifies the group of International forms. This element is part of both request and response. This element does not appear on the forms.
     *
     * @return self
     */
    public function setFormGroupIdName($formGroupIdName)
    {
        ...
        if ((mb_strlen($formGroupIdName) > 50)) {
            throw new \InvalidArgumentException('invalid length for $formGroupIdName when calling ShipmentResultsForm., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($formGroupIdName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $formGroupIdName when calling ShipmentResultsForm., must be bigger than or equal to 1.');
        }
