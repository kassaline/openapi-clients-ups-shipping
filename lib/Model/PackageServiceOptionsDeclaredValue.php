...
class PackageServiceOptionsDeclaredValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'type' => '\OpenAPIClientUPSShipping\Model\DeclaredValueType',
        'currencyCode' => 'string',
    ...
    */
     ...
     * Gets type
     *
     * @return \OpenAPIClientUPSShipping\Model\DeclaredValueType|null
     */
     ...
     * Sets type
     *
     * @param \OpenAPIClientUPSShipping\Model\DeclaredValueType|null $type type
     *
     * @return self
     */
     ...
     * Sets currencyCode
     *
     * @param string $currencyCode Declared value amount currency type. Defaults to the non-Euro currency used in the shippers country or territory.  Code must represent a currency that is a valid for Shipper country or territory.
     *
     * @return self
     */
    public function setCurrencyCode($currencyCode)
    {
        ...
        if ((mb_strlen($currencyCode) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling PackageServiceOptionsDeclaredValue., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currencyCode) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling PackageServiceOptionsDeclaredValue., must be bigger than or equal to 3.');
        }
     ...
     * Sets monetaryValue
     *
     * @param string $monetaryValue Declared value amount.
     *
     * @return self
     */
    public function setMonetaryValue($monetaryValue)
    {
        ...
        if ((mb_strlen($monetaryValue) > 19)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling PackageServiceOptionsDeclaredValue., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($monetaryValue) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling PackageServiceOptionsDeclaredValue., must be bigger than or equal to 1.');
        }
