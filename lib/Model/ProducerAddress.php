...
class ProducerAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets addressLine
     *
     * @param string[] $addressLine Address line of the Producer.
     *
     * @return self
     */
     ...
     *
     * @param string|null $stateProvinceCode State of the Producer.  Applies to NAFTA CO. Required for certain countries or territories.
     *
     * @return self
     */
    public function setStateProvinceCode($stateProvinceCode)
    {
        ...
        if ((mb_strlen($stateProvinceCode) > 5)) {
            throw new \InvalidArgumentException('invalid length for $stateProvinceCode when calling ProducerAddress., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($stateProvinceCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $stateProvinceCode when calling ProducerAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets postalCode
     *
     * @param string|null $postalCode Postal code of the Producer.  Applies to NAFTA CO. Required for certain countries or territories. The length of the postal code depends on the country or territory code.
     *
     * @return self
     */
    public function setPostalCode($postalCode)
    {
        ...
        if ((mb_strlen($postalCode) > 9)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling ProducerAddress., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($postalCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling ProducerAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets countryCode
     *
     * @param string $countryCode Country or Territory code of the Producer.  Applies to NAFTA CO.
     *
     * @return self
     */
    public function setCountryCode($countryCode)
    {
        ...
        if ((mb_strlen($countryCode) > 2)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling ProducerAddress., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($countryCode) < 2)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling ProducerAddress., must be bigger than or equal to 2.');
        }
