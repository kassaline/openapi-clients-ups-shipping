...
class PackageResultsForm implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'code' => 'string',
        'description' => 'string',
        'image' => '\OpenAPIClientUPSShipping\Model\FormImage',
        'formGroupId' => 'string',
    ...
    */
     ...
     * Gets image
     *
     * @return \OpenAPIClientUPSShipping\Model\FormImage|null
     */
     ...
     * Sets image
     *
     * @param \OpenAPIClientUPSShipping\Model\FormImage|null $image image
     *
     * @return self
     */
     ...
     * Sets formGroupId
     *
     * @param string|null $formGroupId Unique Id for later retrieval of saved version of the completed international forms.
     *
     * @return self
     */
    public function setFormGroupId($formGroupId)
    {
        ...
        if ((mb_strlen($formGroupId) > 26)) {
            throw new \InvalidArgumentException('invalid length for $formGroupId when calling PackageResultsForm., must be smaller than or equal to 26.');
        }
        if ((mb_strlen($formGroupId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $formGroupId when calling PackageResultsForm., must be bigger than or equal to 1.');
        }
    ...
    public function setFormGroupIdName($formGroupIdName)
    {
        ...
        if ((mb_strlen($formGroupIdName) > 50)) {
            throw new \InvalidArgumentException('invalid length for $formGroupIdName when calling PackageResultsForm., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($formGroupIdName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $formGroupIdName when calling PackageResultsForm., must be bigger than or equal to 1.');
        }
