...
class ShipmentRequestRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'subVersion' => 'string',
        'transactionReference' => '\OpenAPIClientUPSShipping\Model\RequestTransactionReference'
    ];
    ...
    protected static $setters = [
        'requestOption' => 'setRequestOption',
    ...
    {
        $this->setIfExists('requestOption', $data ?? [], null);
        $this->setIfExists('subVersion', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['requestOption'] === null) {
            $invalidProperties[] = "'requestOption' can't be null";
        }
        if ((mb_strlen($this->container['requestOption']) > 15)) {
            $invalidProperties[] = "invalid value for 'requestOption', the character length must be smaller than or equal to 15.";
        }

        if ((mb_strlen($this->container['requestOption']) < 1)) {
            $invalidProperties[] = "invalid value for 'requestOption', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['subVersion']) && (mb_strlen($this->container['subVersion']) > 4)) {
            $invalidProperties[] = "invalid value for 'subVersion', the character length must be smaller than or equal to 4.";
        }

        if (!is_null($this->container['subVersion']) && (mb_strlen($this->container['subVersion']) < 4)) {
            $invalidProperties[] = "invalid value for 'subVersion', the character length must be bigger than or equal to 4.";
        }
    ...
    public function setRequestOption($requestOption)
    {
        if (is_null($requestOption)) {
            throw new \InvalidArgumentException('non-nullable requestOption cannot be null');
        }
        if ((mb_strlen($requestOption) > 15)) {
            throw new \InvalidArgumentException('invalid length for $requestOption when calling ShipmentRequestRequest., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($requestOption) < 1)) {
            throw new \InvalidArgumentException('invalid length for $requestOption when calling ShipmentRequestRequest., must be bigger than or equal to 1.');
        }

        $this->container['requestOption'] = $requestOption;
     ...
     * Sets subVersion
     *
     * @param string|null $subVersion When UPS introduces new elements in the response that are not associated with new request elements, Subversion is used. This ensures backward compatibility.  To get such elements you need to have the right Subversion. The value of the subversion is explained in the Response element Description.  Example: Itemized Charges are returned only when the Subversion element is present and greater than or equal to 1601.   Format: YYMM = Year and month of the release.  Example: 1607 = 2016 July  Supported values: 1601, 1607, 1701, 1707, 1801, 1807, 2108, 2205
     *
     * @return self
     */
    public function setSubVersion($subVersion)
    {
        if (is_null($subVersion)) {
            throw new \InvalidArgumentException('non-nullable subVersion cannot be null');
        }
        if ((mb_strlen($subVersion) > 4)) {
            throw new \InvalidArgumentException('invalid length for $subVersion when calling ShipmentRequestRequest., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($subVersion) < 4)) {
            throw new \InvalidArgumentException('invalid length for $subVersion when calling ShipmentRequestRequest., must be bigger than or equal to 4.');
        }
     ...
     *
     * @return \OpenAPIClientUPSShipping\Model\RequestTransactionReference|null
     */
     ...
     *
     * @param \OpenAPIClientUPSShipping\Model\RequestTransactionReference|null $transactionReference transactionReference
     *
     * @return self
     */
