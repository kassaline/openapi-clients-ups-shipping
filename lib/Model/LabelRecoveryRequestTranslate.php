...
class LabelRecoveryRequestTranslate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('dialectCode', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['dialectCode'] === null) {
            $invalidProperties[] = "'dialectCode' can't be null";
        }
        if ((mb_strlen($this->container['dialectCode']) > 2)) {
            $invalidProperties[] = "invalid value for 'dialectCode', the character length must be smaller than or equal to 2.";
        }

        if ((mb_strlen($this->container['dialectCode']) < 2)) {
            $invalidProperties[] = "invalid value for 'dialectCode', the character length must be bigger than or equal to 2.";
        }
     ...
     * Sets languageCode
     *
     * @param string $languageCode The Language code. The language codes are three letter language codes. Supported languages are: - eng - English - spa - Spanish - ita - Italian - fra - French - deu - German - por -Portuguese - nld – Dutch - dan - Danish - fin - Finnish - swe – Swedish - nor – Norwegian
     *
     * @return self
     */
    public function setLanguageCode($languageCode)
    {
        ...
        if ((mb_strlen($languageCode) > 3)) {
            throw new \InvalidArgumentException('invalid length for $languageCode when calling LabelRecoveryRequestTranslate., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($languageCode) < 2)) {
            throw new \InvalidArgumentException('invalid length for $languageCode when calling LabelRecoveryRequestTranslate., must be bigger than or equal to 2.');
        }
    ...
    {
        return $this->container['dialectCode'];
    }

    /**
     * Sets dialectCode
     *
     * @param string $dialectCode Valid dialect codes are: - CA - Canada - GB - Great Britain - US - United States - 97 – Not Applicable
     *
     * @return self
     */
    public function setDialectCode($dialectCode)
    {
        if (is_null($dialectCode)) {
            throw new \InvalidArgumentException('non-nullable dialectCode cannot be null');
        }
        if ((mb_strlen($dialectCode) > 2)) {
            throw new \InvalidArgumentException('invalid length for $dialectCode when calling LabelRecoveryRequestTranslate., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($dialectCode) < 2)) {
            throw new \InvalidArgumentException('invalid length for $dialectCode when calling LabelRecoveryRequestTranslate., must be bigger than or equal to 2.');
        }

        $this->container['dialectCode'] = $dialectCode;
