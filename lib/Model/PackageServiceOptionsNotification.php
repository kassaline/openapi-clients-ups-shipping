...
class PackageServiceOptionsNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'eMail' => '\OpenAPIClientUPSShipping\Model\PackageServiceOptionsNotificationEMail'
    ];
    ...
    */
    ...
    public function setNotificationCode($notificationCode)
    {
        ...
        if ((mb_strlen($notificationCode) > 1)) {
            throw new \InvalidArgumentException('invalid length for $notificationCode when calling PackageServiceOptionsNotification., must be smaller than or equal to 1.');
        }
        if ((mb_strlen($notificationCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $notificationCode when calling PackageServiceOptionsNotification., must be bigger than or equal to 1.');
        }
     ...
     * Gets eMail
     *
     * @return \OpenAPIClientUPSShipping\Model\PackageServiceOptionsNotificationEMail
     */
     ...
     * Sets eMail
     *
     * @param \OpenAPIClientUPSShipping\Model\PackageServiceOptionsNotificationEMail $eMail eMail
     *
     * @return self
     */
