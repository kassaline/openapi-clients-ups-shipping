...
class PackageServiceOptionsCOD implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'cODFundsCode' => 'string',
        'cODAmount' => '\OpenAPIClientUPSShipping\Model\PackageServiceOptionsCODCODAmount'
    ];
    ...
    {
        $this->setIfExists('cODFundsCode', $data ?? [], null);
        $this->setIfExists('cODAmount', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cODFundsCode'] === null) {
            $invalidProperties[] = "'cODFundsCode' can't be null";
        }
        if ((mb_strlen($this->container['cODFundsCode']) > 1)) {
            $invalidProperties[] = "invalid value for 'cODFundsCode', the character length must be smaller than or equal to 1.";
        }

        if ((mb_strlen($this->container['cODFundsCode']) < 1)) {
            $invalidProperties[] = "invalid value for 'cODFundsCode', the character length must be bigger than or equal to 1.";
        }

        if ($this->container['cODAmount'] === null) {
            $invalidProperties[] = "'cODAmount' can't be null";
        }
    ...
    {
        return $this->container['cODFundsCode'];
    }

    /**
     * Sets cODFundsCode
     *
     * @param string $cODFundsCode For valid values refer to: Rating and Shipping COD Supported Countries or Territories in the Appendix.
     *
     * @return self
     */
    public function setCODFundsCode($cODFundsCode)
    {
        if (is_null($cODFundsCode)) {
            throw new \InvalidArgumentException('non-nullable cODFundsCode cannot be null');
        }
        if ((mb_strlen($cODFundsCode) > 1)) {
            throw new \InvalidArgumentException('invalid length for $cODFundsCode when calling PackageServiceOptionsCOD., must be smaller than or equal to 1.');
        }
        if ((mb_strlen($cODFundsCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $cODFundsCode when calling PackageServiceOptionsCOD., must be bigger than or equal to 1.');
        }

        $this->container['cODFundsCode'] = $cODFundsCode;
     ...
     * Gets cODAmount
     *
     * @return \OpenAPIClientUPSShipping\Model\PackageServiceOptionsCODCODAmount
     */
     ...
     * Sets cODAmount
     *
     * @param \OpenAPIClientUPSShipping\Model\PackageServiceOptionsCODCODAmount $cODAmount cODAmount
     *
     * @return self
     */
    public function setCODAmount($cODAmount)
    {
        if (is_null($cODAmount)) {
            throw new \InvalidArgumentException('non-nullable cODAmount cannot be null');
        }
