...
class ContactsIntermediateConsignee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'companyName' => 'string',
        'address' => '\OpenAPIClientUPSShipping\Model\IntermediateConsigneeAddress'
    ];
    ...
    */
     ...
     * Sets companyName
     *
     * @param string $companyName Company Name or the Individual name of the Intermediate consignee.  Applicable for EEI form only.
     *
     * @return self
     */
    public function setCompanyName($companyName)
    {
        ...
        if ((mb_strlen($companyName) > 35)) {
            throw new \InvalidArgumentException('invalid length for $companyName when calling ContactsIntermediateConsignee., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($companyName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $companyName when calling ContactsIntermediateConsignee., must be bigger than or equal to 1.');
        }
     ...
     * Gets address
     *
     * @return \OpenAPIClientUPSShipping\Model\IntermediateConsigneeAddress
     */
     ...
     * Sets address
     *
     * @param \OpenAPIClientUPSShipping\Model\IntermediateConsigneeAddress $address address
     *
     * @return self
     */
