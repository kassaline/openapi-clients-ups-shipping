 ...
 */
class AddressPOE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Address_POE';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['stateProvinceCode']) && (mb_strlen($this->container['stateProvinceCode']) < 2)) {
            $invalidProperties[] = "invalid value for 'stateProvinceCode', the character length must be bigger than or equal to 2.";
        }
        ...
        if (!is_null($this->container['postalCode']) && (mb_strlen($this->container['postalCode']) < 5)) {
            $invalidProperties[] = "invalid value for 'postalCode', the character length must be bigger than or equal to 5.";
        }

        if (!is_null($this->container['postalCode']) && !preg_match("/^\\d{5}(?:[-\\s]\\d{4})?$/", $this->container['postalCode'])) {
            $invalidProperties[] = "invalid value for 'postalCode', must be conform to the pattern /^\\d{5}(?:[-\\s]\\d{4})?$/.";
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) > 30)) {
            throw new \InvalidArgumentException('invalid length for $city when calling AddressPOE., must be smaller than or equal to 30.');
        }
     ...
     *
     * @param string|null $stateProvinceCode The code of the address's admininstrative division (state, province, distict, prefecture, etc...).
     *
     * @return self
     */
    public function setStateProvinceCode($stateProvinceCode)
    {
        ...
        if ((mb_strlen($stateProvinceCode) > 5)) {
            throw new \InvalidArgumentException('invalid length for $stateProvinceCode when calling AddressPOE., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($stateProvinceCode) < 2)) {
            throw new \InvalidArgumentException('invalid length for $stateProvinceCode when calling AddressPOE., must be bigger than or equal to 2.');
        }
    ...
    public function setPostalCode($postalCode)
    {
        ...
        if ((mb_strlen($postalCode) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling AddressPOE., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($postalCode) < 5)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling AddressPOE., must be bigger than or equal to 5.');
        }
        if ((!preg_match("/^\\d{5}(?:[-\\s]\\d{4})?$/", ObjectSerializer::toString($postalCode)))) {
            throw new \InvalidArgumentException("invalid value for \$postalCode when calling AddressPOE., must conform to the pattern /^\\d{5}(?:[-\\s]\\d{4})?$/.");
        }
    ...
    public function setCountryCode($countryCode)
    {
        ...
        if ((mb_strlen($countryCode) > 2)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling AddressPOE., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($countryCode) < 2)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling AddressPOE., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[A-Z]{2}$/", ObjectSerializer::toString($countryCode)))) {
            throw new \InvalidArgumentException("invalid value for \$countryCode when calling AddressPOE., must conform to the pattern /^[A-Z]{2}$/.");
        }
