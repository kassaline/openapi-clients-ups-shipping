 ...
 */
class PackageServiceOptionsNotificationEMail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PackageServiceOptions_Notification_EMail';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('subjectCode', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['subjectCode']) && (mb_strlen($this->container['subjectCode']) > 2)) {
            $invalidProperties[] = "invalid value for 'subjectCode', the character length must be smaller than or equal to 2.";
        }

        if (!is_null($this->container['subjectCode']) && (mb_strlen($this->container['subjectCode']) < 1)) {
            $invalidProperties[] = "invalid value for 'subjectCode', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setSubject($subject)
    {
        ...
        if ((mb_strlen($subject) > 75)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling PackageServiceOptionsNotificationEMail., must be smaller than or equal to 75.');
        }
        if ((mb_strlen($subject) < 1)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling PackageServiceOptionsNotificationEMail., must be bigger than or equal to 1.');
        }
    ...
    {
        return $this->container['subjectCode'];
    }
    ...
    public function setSubjectCode($subjectCode)
    {
        if (is_null($subjectCode)) {
            throw new \InvalidArgumentException('non-nullable subjectCode cannot be null');
        }
        if ((mb_strlen($subjectCode) > 2)) {
            throw new \InvalidArgumentException('invalid length for $subjectCode when calling PackageServiceOptionsNotificationEMail., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($subjectCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $subjectCode when calling PackageServiceOptionsNotificationEMail., must be bigger than or equal to 1.');
        }

        $this->container['subjectCode'] = $subjectCode;
     ...
     * Sets eMailAddress
     *
     * @param string[] $eMailAddress The destination email address of the receiver returns notification email.
     *
     * @return self
     */
     ...
     *
     * @param string|null $undeliverableEMailAddress The e-mail address where an undeliverable email message is sent if the Receiver Return Notification email is undeliverable. Defaults to FromEMailAddress. Only allowed at the first package.
     *
     * @return self
     */
    public function setUndeliverableEMailAddress($undeliverableEMailAddress)
    {
        ...
        if ((mb_strlen($undeliverableEMailAddress) > 50)) {
            throw new \InvalidArgumentException('invalid length for $undeliverableEMailAddress when calling PackageServiceOptionsNotificationEMail., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($undeliverableEMailAddress) < 1)) {
            throw new \InvalidArgumentException('invalid length for $undeliverableEMailAddress when calling PackageServiceOptionsNotificationEMail., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $fromEMailAddress The email address listed in the Reply To field of the message header, includes name and e-mail address of sender. The \"From\" field of the message header contains pkginfo@ups.com.  Only allowed at the first package.
     *
     * @return self
     */
    public function setFromEMailAddress($fromEMailAddress)
    {
        ...
        if ((mb_strlen($fromEMailAddress) > 50)) {
            throw new \InvalidArgumentException('invalid length for $fromEMailAddress when calling PackageServiceOptionsNotificationEMail., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($fromEMailAddress) < 1)) {
            throw new \InvalidArgumentException('invalid length for $fromEMailAddress when calling PackageServiceOptionsNotificationEMail., must be bigger than or equal to 1.');
        }
     ...
     * Sets fromName
     *
     * @param string|null $fromName The name the receiver return notification will appear to be from. Defaults to the Shipper Name. Only allowed at the first package.
     *
     * @return self
     */
    public function setFromName($fromName)
    {
        ...
        if ((mb_strlen($fromName) > 35)) {
            throw new \InvalidArgumentException('invalid length for $fromName when calling PackageServiceOptionsNotificationEMail., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($fromName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $fromName when calling PackageServiceOptionsNotificationEMail., must be bigger than or equal to 1.');
        }
    ...
    public function setMemo($memo)
    {
        ...
        if ((mb_strlen($memo) > 150)) {
            throw new \InvalidArgumentException('invalid length for $memo when calling PackageServiceOptionsNotificationEMail., must be smaller than or equal to 150.');
        }
        if ((mb_strlen($memo) < 1)) {
            throw new \InvalidArgumentException('invalid length for $memo when calling PackageServiceOptionsNotificationEMail., must be bigger than or equal to 1.');
        }
