...
/**
 * LTLDimensions Class Doc Comment
 *
 * @category Class
 ...
 */
class LTLDimensions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LTL_Dimensions';
    ...
    */
     ...
     * Sets length
     *
     * @param string $length Length of the package/ltl.
     *
     * @return self
     */
     ...
     * Sets width
     *
     * @param string $width Width of the package/ltl.
     *
     * @return self
     */
     ...
     * Sets height
     *
     * @param string $height Height of the package/ltl.
     *
     * @return self
     */
     ...
     *
     * @param string $unitOfMeasurement The code associated with unit of measurement. The requested code must be valid for the shipper country or territory.  Valid values are :  - IN = Inches - CM = Centimeters
     *
     * @return self
     */
