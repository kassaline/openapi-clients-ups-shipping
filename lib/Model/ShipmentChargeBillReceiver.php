...
class ShipmentChargeBillReceiver implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'address' => '\OpenAPIClientUPSShipping\Model\BillReceiverAddress'
    ];
    ...
    */
    ...
    public function setAccountNumber($accountNumber)
    {
        ...
        if ((mb_strlen($accountNumber) > 6)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling ShipmentChargeBillReceiver., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($accountNumber) < 6)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling ShipmentChargeBillReceiver., must be bigger than or equal to 6.');
        }
     ...
     * Gets address
     *
     * @return \OpenAPIClientUPSShipping\Model\BillReceiverAddress|null
     */
     ...
     * Sets address
     *
     * @param \OpenAPIClientUPSShipping\Model\BillReceiverAddress|null $address address
     *
     * @return self
     */
