...
class FRSPaymentInformationType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $code when calling FRSPaymentInformationType., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling FRSPaymentInformationType., must be bigger than or equal to 1.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Specifies the description for Ground Freight Pricing payment type.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 50)) {
            throw new \InvalidArgumentException('invalid length for $description when calling FRSPaymentInformationType., must be smaller than or equal to 50.');
        }
