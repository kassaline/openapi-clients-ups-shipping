    ...
    */
    ...
    public function setBeginDate($beginDate)
    {
        ...
        if ((mb_strlen($beginDate) > 8)) {
            throw new \InvalidArgumentException('invalid length for $beginDate when calling InternationalFormsBlanketPeriod., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($beginDate) < 8)) {
            throw new \InvalidArgumentException('invalid length for $beginDate when calling InternationalFormsBlanketPeriod., must be bigger than or equal to 8.');
        }
     ...
     * Sets endDate
     *
     * @param string $endDate End Date of the blanket period. It is the date upon which the blanket period expires.  Applies to NAFTA CO form only. Required for NAFTA CO. Format is yyyyMMdd.  This is not valid for a paperless shipment.
     *
     * @return self
     */
    public function setEndDate($endDate)
    {
        ...
        if ((mb_strlen($endDate) > 8)) {
            throw new \InvalidArgumentException('invalid length for $endDate when calling InternationalFormsBlanketPeriod., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($endDate) < 8)) {
            throw new \InvalidArgumentException('invalid length for $endDate when calling InternationalFormsBlanketPeriod., must be bigger than or equal to 8.');
        }
