...
class TrackingCandidatePickupDateRange implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets beginDate
     *
     * @param string $beginDate The beginning of the date range for the candidate. Format: YYYYMMDD  Service is only supported for 30 days
     *
     * @return self
     */
    public function setBeginDate($beginDate)
    {
        ...
        if ((mb_strlen($beginDate) > 8)) {
            throw new \InvalidArgumentException('invalid length for $beginDate when calling TrackingCandidatePickupDateRange., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($beginDate) < 8)) {
            throw new \InvalidArgumentException('invalid length for $beginDate when calling TrackingCandidatePickupDateRange., must be bigger than or equal to 8.');
        }
     ...
     * Sets endDate
     *
     * @param string $endDate The end of the date range for the candidate. Format: YYYYMMDD
     *
     * @return self
     */
    public function setEndDate($endDate)
    {
        ...
        if ((mb_strlen($endDate) > 8)) {
            throw new \InvalidArgumentException('invalid length for $endDate when calling TrackingCandidatePickupDateRange., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($endDate) < 8)) {
            throw new \InvalidArgumentException('invalid length for $endDate when calling TrackingCandidatePickupDateRange., must be bigger than or equal to 8.');
        }
