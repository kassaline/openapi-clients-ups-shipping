 ...
 */
class PackageServiceOptionsCODCODAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PackageServiceOptions_COD_CODAmount';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['monetaryValue']) > 5)) {
            $invalidProperties[] = "invalid value for 'monetaryValue', the character length must be smaller than or equal to 5.";
        }

        if ((mb_strlen($this->container['monetaryValue']) < 5)) {
            $invalidProperties[] = "invalid value for 'monetaryValue', the character length must be bigger than or equal to 5.";
        }
     ...
     * Sets currencyCode
     *
     * @param string $currencyCode COD amount currency code type.
     *
     * @return self
     */
    public function setCurrencyCode($currencyCode)
    {
        ...
        if ((mb_strlen($currencyCode) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling PackageServiceOptionsCODCODAmount., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currencyCode) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling PackageServiceOptionsCODCODAmount., must be bigger than or equal to 3.');
        }
     ...
     * Sets monetaryValue
     *
     * @param string $monetaryValue COD Amount. Valid values: 0.01 USD to 50000.00 USD
     *
     * @return self
     */
    public function setMonetaryValue($monetaryValue)
    {
        ...
        if ((mb_strlen($monetaryValue) > 5)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling PackageServiceOptionsCODCODAmount., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($monetaryValue) < 5)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling PackageServiceOptionsCODCODAmount., must be bigger than or equal to 5.');
        }
