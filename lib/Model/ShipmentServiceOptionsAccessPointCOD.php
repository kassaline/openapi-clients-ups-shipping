...
class ShipmentServiceOptionsAccessPointCOD implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['monetaryValue']) > 8)) {
            $invalidProperties[] = "invalid value for 'monetaryValue', the character length must be smaller than or equal to 8.";
        }
     ...
     * Sets currencyCode
     *
     * @param string $currencyCode Access Point COD Currency Code.
     *
     * @return self
     */
    public function setCurrencyCode($currencyCode)
    {
        ...
        if ((mb_strlen($currencyCode) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling ShipmentServiceOptionsAccessPointCOD., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currencyCode) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling ShipmentServiceOptionsAccessPointCOD., must be bigger than or equal to 3.');
        }
     ...
     * Sets monetaryValue
     *
     * @param string $monetaryValue Access Point COD Monetary Value.
     *
     * @return self
     */
    public function setMonetaryValue($monetaryValue)
    {
        ...
        if ((mb_strlen($monetaryValue) > 8)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling ShipmentServiceOptionsAccessPointCOD., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($monetaryValue) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling ShipmentServiceOptionsAccessPointCOD., must be bigger than or equal to 1.');
        }
