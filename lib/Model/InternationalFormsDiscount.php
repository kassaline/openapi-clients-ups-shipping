...
class InternationalFormsDiscount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['monetaryValue']) > 15)) {
            $invalidProperties[] = "invalid value for 'monetaryValue', the character length must be smaller than or equal to 15.";
        }
    ...
    public function setMonetaryValue($monetaryValue)
    {
        ...
        if ((mb_strlen($monetaryValue) > 15)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling InternationalFormsDiscount., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($monetaryValue) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling InternationalFormsDiscount., must be bigger than or equal to 1.');
        }
