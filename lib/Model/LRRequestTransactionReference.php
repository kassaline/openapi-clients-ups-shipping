...
class LRRequestTransactionReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['customerContext']) && (mb_strlen($this->container['customerContext']) < 5)) {
            $invalidProperties[] = "invalid value for 'customerContext', the character length must be bigger than or equal to 5.";
        }
    ...
    public function setCustomerContext($customerContext)
    {
        ...
        if ((mb_strlen($customerContext) > 512)) {
            throw new \InvalidArgumentException('invalid length for $customerContext when calling LRRequestTransactionReference., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($customerContext) < 5)) {
            throw new \InvalidArgumentException('invalid length for $customerContext when calling LRRequestTransactionReference., must be bigger than or equal to 5.');
        }
