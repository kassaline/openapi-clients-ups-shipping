...
/**
 * LTLOtherCharges Class Doc Comment
 *
 * @category Class
 * @description Any other miscellaneous charges.
 * @package  OpenAPIClientUPSShipping
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class LTLOtherCharges implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LTL_Other_Charges';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[0-9]+(\\.[0-9]{1,2})?$/", $this->container['monetaryValue'])) {
            $invalidProperties[] = "invalid value for 'monetaryValue', must be conform to the pattern /^[0-9]+(\\.[0-9]{1,2})?$/.";
        }

        if ($this->container['chargeDescription'] === null) {
            $invalidProperties[] = "'chargeDescription' can't be null";
        }
        if (!preg_match("/^[a-zA-Z0-9 ]{1,30}$/", $this->container['chargeDescription'])) {
            $invalidProperties[] = "invalid value for 'chargeDescription', must be conform to the pattern /^[a-zA-Z0-9 ]{1,30}$/.";
        }
     ...
     * Sets monetaryValue
     *
     * @param string $monetaryValue The amount the shipper or receiver pays to cover the cost associated with the LTL Charges.
     *
     * @return self
     */
    public function setMonetaryValue($monetaryValue)
    {
        ...
        if ((!preg_match("/^[0-9]+(\\.[0-9]{1,2})?$/", ObjectSerializer::toString($monetaryValue)))) {
            throw new \InvalidArgumentException("invalid value for \$monetaryValue when calling LTLOtherCharges., must conform to the pattern /^[0-9]+(\\.[0-9]{1,2})?$/.");
        }
     ...
     *
     * @param string $chargeDescription Description of what the other charges are for.
     *
     * @return self
     */
    public function setChargeDescription($chargeDescription)
    {
        if (is_null($chargeDescription)) {
            throw new \InvalidArgumentException('non-nullable chargeDescription cannot be null');
        }

        if ((!preg_match("/^[a-zA-Z0-9 ]{1,30}$/", ObjectSerializer::toString($chargeDescription)))) {
            throw new \InvalidArgumentException("invalid value for \$chargeDescription when calling LTLOtherCharges., must conform to the pattern /^[a-zA-Z0-9 ]{1,30}$/.");
        }
