...
class AlternateDeliveryAddressAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets addressLine
     *
     * @param string[] $addressLine Address Line of the Retail Location.
     *
     * @return self
     */
     ...
     *
     * @param string|null $stateProvinceCode Retail Location state or province code. Required for US or Canada.  If destination is US or CA, then the value must be a valid US State/Canadian Province code.  If the country or territory is Ireland, the StateProvinceCode will contain the county.
     *
     * @return self
     */
    public function setStateProvinceCode($stateProvinceCode)
    {
        ...
        if ((mb_strlen($stateProvinceCode) > 5)) {
            throw new \InvalidArgumentException('invalid length for $stateProvinceCode when calling AlternateDeliveryAddressAddress., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($stateProvinceCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $stateProvinceCode when calling AlternateDeliveryAddressAddress., must be bigger than or equal to 1.');
        }
    ...
    public function setPostalCode($postalCode)
    {
        ...
        if ((mb_strlen($postalCode) > 9)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling AlternateDeliveryAddressAddress., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($postalCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling AlternateDeliveryAddressAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets countryCode
     *
     * @param string $countryCode Retail Location country or territory code.
     *
     * @return self
     */
    public function setCountryCode($countryCode)
    {
        ...
        if ((mb_strlen($countryCode) > 2)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling AlternateDeliveryAddressAddress., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($countryCode) < 2)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling AlternateDeliveryAddressAddress., must be bigger than or equal to 2.');
        }
