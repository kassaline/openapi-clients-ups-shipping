...
class ErrorResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPIClientUPSShipping\Model\CommonErrorResponse'
    ];
    ...
    */
     ...
     * Gets response
     *
     * @return \OpenAPIClientUPSShipping\Model\CommonErrorResponse|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPIClientUPSShipping\Model\CommonErrorResponse|null $response response
     *
     * @return self
     */
