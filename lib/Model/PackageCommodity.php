...
class PackageCommodity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'freightClass' => 'string',
        'nMFC' => '\OpenAPIClientUPSShipping\Model\CommodityNMFC'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['freightClass']) > 10)) {
            $invalidProperties[] = "invalid value for 'freightClass', the character length must be smaller than or equal to 10.";
        }

        if ((mb_strlen($this->container['freightClass']) < 10)) {
            $invalidProperties[] = "invalid value for 'freightClass', the character length must be bigger than or equal to 10.";
        }
     ...
     * Sets freightClass
     *
     * @param string $freightClass Freight Classification. Freight class partially determines the freight rate for the article.  Required for Ground Freight Pricing Shipments only.
     *
     * @return self
     */
    public function setFreightClass($freightClass)
    {
        ...
        if ((mb_strlen($freightClass) > 10)) {
            throw new \InvalidArgumentException('invalid length for $freightClass when calling PackageCommodity., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($freightClass) < 10)) {
            throw new \InvalidArgumentException('invalid length for $freightClass when calling PackageCommodity., must be bigger than or equal to 10.');
        }
     ...
     * Gets nMFC
     *
     * @return \OpenAPIClientUPSShipping\Model\CommodityNMFC|null
     */
     ...
     * Sets nMFC
     *
     * @param \OpenAPIClientUPSShipping\Model\CommodityNMFC|null $nMFC nMFC
     *
     * @return self
     */
