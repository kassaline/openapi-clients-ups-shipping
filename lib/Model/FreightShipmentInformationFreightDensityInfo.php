...
class FreightShipmentInformationFreightDensityInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'adjustedHeight' => '\OpenAPIClientUPSShipping\Model\FreightDensityInfoAdjustedHeight',
        'handlingUnits' => '\OpenAPIClientUPSShipping\Model\FreightDensityInfoHandlingUnits[]'
    ];
    ...
    protected static $attributeMap = [
        'adjustedHeightIndicator' => 'AdjustedHeightIndicator',
    ...
    protected static $setters = [
        'adjustedHeightIndicator' => 'setAdjustedHeightIndicator',
        'adjustedHeight' => 'setAdjustedHeight',
    ...
    protected static $getters = [
        'adjustedHeightIndicator' => 'getAdjustedHeightIndicator',
    ...
    {
        $this->setIfExists('adjustedHeightIndicator', $data ?? [], null);
        $this->setIfExists('adjustedHeight', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets adjustedHeightIndicator
     *
     * @return string|null
     */
    public function getAdjustedHeightIndicator()
    {
        return $this->container['adjustedHeightIndicator'];
    }

    /**
     * Sets adjustedHeightIndicator
     *
     * @param string|null $adjustedHeightIndicator The presence of the AdjustedHeightIndicator indicates that allow the height reduction adjustment for density based rate request.
     *
     * @return self
     */
    public function setAdjustedHeightIndicator($adjustedHeightIndicator)
    {
        if (is_null($adjustedHeightIndicator)) {
            throw new \InvalidArgumentException('non-nullable adjustedHeightIndicator cannot be null');
        }


        $this->container['adjustedHeightIndicator'] = $adjustedHeightIndicator;
     ...
     * Gets adjustedHeight
     *
     * @return \OpenAPIClientUPSShipping\Model\FreightDensityInfoAdjustedHeight|null
     */
    public function getAdjustedHeight()
    {
        return $this->container['adjustedHeight'];
    }

    /**
     * Sets adjustedHeight
     *
     * @param \OpenAPIClientUPSShipping\Model\FreightDensityInfoAdjustedHeight|null $adjustedHeight adjustedHeight
     *
     * @return self
     */
    public function setAdjustedHeight($adjustedHeight)
    {
        if (is_null($adjustedHeight)) {
            throw new \InvalidArgumentException('non-nullable adjustedHeight cannot be null');
        }
        $this->container['adjustedHeight'] = $adjustedHeight;
     ...
     * Gets handlingUnits
     *
     * @return \OpenAPIClientUPSShipping\Model\FreightDensityInfoHandlingUnits[]|null
     */
     ...
     * Sets handlingUnits
     *
     * @param \OpenAPIClientUPSShipping\Model\FreightDensityInfoHandlingUnits[]|null $handlingUnits handlingUnits
     *
     * @return self
     */
