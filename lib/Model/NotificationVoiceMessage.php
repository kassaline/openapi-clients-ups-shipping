...
class NotificationVoiceMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets phoneNumber
     *
     * @param string $phoneNumber Phone number for receiving Voice Alternate Delivery Location notification and UAP Shipper notification.
     *
     * @return self
     */
    public function setPhoneNumber($phoneNumber)
    {
        ...
        if ((mb_strlen($phoneNumber) > 15)) {
            throw new \InvalidArgumentException('invalid length for $phoneNumber when calling NotificationVoiceMessage., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($phoneNumber) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phoneNumber when calling NotificationVoiceMessage., must be bigger than or equal to 1.');
        }
