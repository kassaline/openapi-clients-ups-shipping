 ...
 */
class LabelRecoveryLabelSpecificationLabelImageFormat implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LabelRecovery_LabelSpecification_LabelImageFormat';
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $code when calling LabelRecoveryLabelSpecificationLabelImageFormat., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($code) < 4)) {
            throw new \InvalidArgumentException('invalid length for $code when calling LabelRecoveryLabelSpecificationLabelImageFormat., must be bigger than or equal to 4.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 35)) {
            throw new \InvalidArgumentException('invalid length for $description when calling LabelRecoveryLabelSpecificationLabelImageFormat., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling LabelRecoveryLabelSpecificationLabelImageFormat., must be bigger than or equal to 1.');
        }
