...
class FRSPaymentInformationAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets postalCode
     *
     * @param string|null $postalCode The postal code for the Ground Freight Pricing payment information address.
     *
     * @return self
     */
    public function setPostalCode($postalCode)
    {
        ...
        if ((mb_strlen($postalCode) > 9)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling FRSPaymentInformationAddress., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($postalCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling FRSPaymentInformationAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets countryCode
     *
     * @param string $countryCode The country or territory code for the Ground Freight Pricing payment information address.
     *
     * @return self
     */
    public function setCountryCode($countryCode)
    {
        ...
        if ((mb_strlen($countryCode) > 2)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling FRSPaymentInformationAddress., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($countryCode) < 2)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling FRSPaymentInformationAddress., must be bigger than or equal to 2.');
        }
