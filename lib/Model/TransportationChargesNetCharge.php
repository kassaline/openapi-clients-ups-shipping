...
class TransportationChargesNetCharge implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets currencyCode
     *
     * @param string $currencyCode Net Charge currency code.
     *
     * @return self
     */
    public function setCurrencyCode($currencyCode)
    {
        ...
        if ((mb_strlen($currencyCode) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling TransportationChargesNetCharge., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currencyCode) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling TransportationChargesNetCharge., must be bigger than or equal to 3.');
        }
     ...
     * Sets monetaryValue
     *
     * @param string $monetaryValue Net charges monetary value.  Valid values are from 0 to 9999999999999999.99
     *
     * @return self
     */
    public function setMonetaryValue($monetaryValue)
    {
        ...
        if ((mb_strlen($monetaryValue) > 19)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling TransportationChargesNetCharge., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($monetaryValue) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling TransportationChargesNetCharge., must be bigger than or equal to 1.');
        }
