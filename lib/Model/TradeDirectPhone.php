...
/**
 * TradeDirectPhone Class Doc Comment
 *
 * @category Class
 * @description Contains the phone details including the phone number and extension.
 * @package  OpenAPIClientUPSShipping
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class TradeDirectPhone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TradeDirect_Phone';
    ...
    */
     ...
     * Sets extension
     *
     * @param string|null $extension The phone extension of the contact.
     *
     * @return self
     */
