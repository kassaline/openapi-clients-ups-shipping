    ...
    */
    ...
    public function setCurrencyCode($currencyCode)
    {
        ...
        if ((mb_strlen($currencyCode) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling ShipmentChargesItemizedCharges., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currencyCode) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling ShipmentChargesItemizedCharges., must be bigger than or equal to 3.');
        }
    ...
    public function setMonetaryValue($monetaryValue)
    {
        ...
        if ((mb_strlen($monetaryValue) > 19)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling ShipmentChargesItemizedCharges., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($monetaryValue) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling ShipmentChargesItemizedCharges., must be bigger than or equal to 1.');
        }
    ...
    public function setSubType($subType)
    {
        ...
        if ((mb_strlen($subType) > 50)) {
            throw new \InvalidArgumentException('invalid length for $subType when calling ShipmentChargesItemizedCharges., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($subType) < 1)) {
            throw new \InvalidArgumentException('invalid length for $subType when calling ShipmentChargesItemizedCharges., must be bigger than or equal to 1.');
        }
