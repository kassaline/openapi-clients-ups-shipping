...
class LabelDeliveryEMail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets eMailAddress
     *
     * @param string $eMailAddress The destination eMail address for the Label Delivery.
     *
     * @return self
     */
    public function setEMailAddress($eMailAddress)
    {
        ...
        if ((mb_strlen($eMailAddress) > 50)) {
            throw new \InvalidArgumentException('invalid length for $eMailAddress when calling LabelDeliveryEMail., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($eMailAddress) < 1)) {
            throw new \InvalidArgumentException('invalid length for $eMailAddress when calling LabelDeliveryEMail., must be bigger than or equal to 1.');
        }
