...
class ShipmentInvoiceLineTotal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['monetaryValue']) > 11)) {
            $invalidProperties[] = "invalid value for 'monetaryValue', the character length must be smaller than or equal to 11.";
        }
     ...
     * Sets currencyCode
     *
     * @param string $currencyCode Invoice Line Total currency type.
     *
     * @return self
     */
    public function setCurrencyCode($currencyCode)
    {
        ...
        if ((mb_strlen($currencyCode) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling ShipmentInvoiceLineTotal., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currencyCode) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling ShipmentInvoiceLineTotal., must be bigger than or equal to 3.');
        }
     ...
     * Sets monetaryValue
     *
     * @param string $monetaryValue Invoice Line Total amount for the entire shipment.  Valid values are from 1 to 99999999
     *
     * @return self
     */
    public function setMonetaryValue($monetaryValue)
    {
        ...
        if ((mb_strlen($monetaryValue) > 11)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling ShipmentInvoiceLineTotal., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($monetaryValue) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling ShipmentInvoiceLineTotal., must be bigger than or equal to 1.');
        }
