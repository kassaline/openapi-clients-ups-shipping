 ...
 */
class CODTurnInPageImageImageFormat implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CODTurnInPage_Image_ImageFormat';
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $code when calling CODTurnInPageImageImageFormat., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $code when calling CODTurnInPageImageImageFormat., must be bigger than or equal to 3.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 35)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CODTurnInPageImageImageFormat., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CODTurnInPageImageImageFormat., must be bigger than or equal to 1.');
        }
