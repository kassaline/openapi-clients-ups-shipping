...
class VoidResponseTransactionReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('customerContext', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['customerContext']) && (mb_strlen($this->container['customerContext']) > 512)) {
            $invalidProperties[] = "invalid value for 'customerContext', the character length must be smaller than or equal to 512.";
        }

        if (!is_null($this->container['customerContext']) && (mb_strlen($this->container['customerContext']) < 1)) {
            $invalidProperties[] = "invalid value for 'customerContext', the character length must be bigger than or equal to 1.";
        }
    ...
    /**
     * Gets customerContext
     *
     * @return string|null
     */
    public function getCustomerContext()
    {
        return $this->container['customerContext'];
    }

    /**
     * Sets customerContext
     *
     * @param string|null $customerContext The CustomerContext Information which will be echoed during response.
     *
     * @return self
     */
    public function setCustomerContext($customerContext)
    {
        if (is_null($customerContext)) {
            throw new \InvalidArgumentException('non-nullable customerContext cannot be null');
        }
        if ((mb_strlen($customerContext) > 512)) {
            throw new \InvalidArgumentException('invalid length for $customerContext when calling VoidResponseTransactionReference., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($customerContext) < 1)) {
            throw new \InvalidArgumentException('invalid length for $customerContext when calling VoidResponseTransactionReference., must be bigger than or equal to 1.');
        }

        $this->container['customerContext'] = $customerContext;
