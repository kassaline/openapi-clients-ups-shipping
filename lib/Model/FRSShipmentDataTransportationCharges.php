...
class FRSShipmentDataTransportationCharges implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'grossCharge' => '\OpenAPIClientUPSShipping\Model\TransportationChargesGrossCharge',
        'discountAmount' => '\OpenAPIClientUPSShipping\Model\TransportationChargesDiscountAmount',
        'discountPercentage' => 'string',
        'netCharge' => '\OpenAPIClientUPSShipping\Model\TransportationChargesNetCharge'
    ];
    ...
    {
        $this->setIfExists('grossCharge', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['grossCharge'] === null) {
            $invalidProperties[] = "'grossCharge' can't be null";
        }
        ...
        if ((mb_strlen($this->container['discountPercentage']) > 5)) {
            $invalidProperties[] = "invalid value for 'discountPercentage', the character length must be smaller than or equal to 5.";
        }

        if ((mb_strlen($this->container['discountPercentage']) < 1)) {
            $invalidProperties[] = "invalid value for 'discountPercentage', the character length must be bigger than or equal to 1.";
        }

        if ($this->container['netCharge'] === null) {
            $invalidProperties[] = "'netCharge' can't be null";
        }
     ...
     * Gets grossCharge
     *
     * @return \OpenAPIClientUPSShipping\Model\TransportationChargesGrossCharge
     */
    public function getGrossCharge()
    {
        return $this->container['grossCharge'];
    }

    /**
     * Sets grossCharge
     *
     * @param \OpenAPIClientUPSShipping\Model\TransportationChargesGrossCharge $grossCharge grossCharge
     *
     * @return self
     */
    public function setGrossCharge($grossCharge)
    {
        if (is_null($grossCharge)) {
            throw new \InvalidArgumentException('non-nullable grossCharge cannot be null');
        }
        $this->container['grossCharge'] = $grossCharge;
     ...
     * Gets discountAmount
     *
     * @return \OpenAPIClientUPSShipping\Model\TransportationChargesDiscountAmount
     */
     ...
     * Sets discountAmount
     *
     * @param \OpenAPIClientUPSShipping\Model\TransportationChargesDiscountAmount $discountAmount discountAmount
     *
     * @return self
     */
     ...
     *
     * @param string $discountPercentage It indicates the shipment level discount percentage for transportation charges.
     *
     * @return self
     */
    public function setDiscountPercentage($discountPercentage)
    {
        ...
        if ((mb_strlen($discountPercentage) > 5)) {
            throw new \InvalidArgumentException('invalid length for $discountPercentage when calling FRSShipmentDataTransportationCharges., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($discountPercentage) < 1)) {
            throw new \InvalidArgumentException('invalid length for $discountPercentage when calling FRSShipmentDataTransportationCharges., must be bigger than or equal to 1.');
        }
     ...
     * Gets netCharge
     *
     * @return \OpenAPIClientUPSShipping\Model\TransportationChargesNetCharge
     */
     ...
     * Sets netCharge
     *
     * @param \OpenAPIClientUPSShipping\Model\TransportationChargesNetCharge $netCharge netCharge
     *
     * @return self
     */
