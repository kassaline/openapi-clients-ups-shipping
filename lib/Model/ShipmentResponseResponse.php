...
class ShipmentResponseResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'responseStatus' => '\OpenAPIClientUPSShipping\Model\ResponseResponseStatus',
        'alert' => '\OpenAPIClientUPSShipping\Model\ResponseAlert[]',
        'transactionReference' => '\OpenAPIClientUPSShipping\Model\ResponseTransactionReference'
    ];
    ...
    {
        $this->setIfExists('responseStatus', $data ?? [], null);
    ...
    */
     ...
     * Gets responseStatus
     *
     * @return \OpenAPIClientUPSShipping\Model\ResponseResponseStatus
     */
     ...
     * Sets responseStatus
     *
     * @param \OpenAPIClientUPSShipping\Model\ResponseResponseStatus $responseStatus responseStatus
     *
     * @return self
     */
    public function setResponseStatus($responseStatus)
    {
        if (is_null($responseStatus)) {
            throw new \InvalidArgumentException('non-nullable responseStatus cannot be null');
        }
     ...
     * Gets alert
     *
     * @return \OpenAPIClientUPSShipping\Model\ResponseAlert[]|null
     */
     ...
     * Sets alert
     *
     * @param \OpenAPIClientUPSShipping\Model\ResponseAlert[]|null $alert Alert Container.  There can be zero to many alert containers with code and description.  **NOTE:** For versions >= v2403, this element will always be returned as an array. For requests using versions < v2403, this element will be returned as an array if there is more than one object and a single object if there is only 1.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPIClientUPSShipping\Model\ResponseTransactionReference|null
     */
     ...
     *
     * @param \OpenAPIClientUPSShipping\Model\ResponseTransactionReference|null $transactionReference transactionReference
     *
     * @return self
     */
