...
class VoidShipmentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPIClientUPSShipping\Model\VoidShipmentResponseResponse',
        'summaryResult' => '\OpenAPIClientUPSShipping\Model\VoidShipmentResponseSummaryResult',
    ...
    protected static $setters = [
        ...
        'packageLevelResults' => 'setPackageLevelResults'
    ];
    ...
    protected static $getters = [
        ...
        'packageLevelResults' => 'getPackageLevelResults'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('summaryResult', $data ?? [], null);
        $this->setIfExists('packageLevelResults', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['summaryResult'] === null) {
            $invalidProperties[] = "'summaryResult' can't be null";
        }
     ...
     * Gets response
     *
     * @return \OpenAPIClientUPSShipping\Model\VoidShipmentResponseResponse
     */
     ...
     * Sets response
     *
     * @param \OpenAPIClientUPSShipping\Model\VoidShipmentResponseResponse $response response
     *
     * @return self
     */
     ...
     * Gets summaryResult
     *
     * @return \OpenAPIClientUPSShipping\Model\VoidShipmentResponseSummaryResult
     */
    public function getSummaryResult()
    {
        return $this->container['summaryResult'];
    }

    /**
     * Sets summaryResult
     *
     * @param \OpenAPIClientUPSShipping\Model\VoidShipmentResponseSummaryResult $summaryResult summaryResult
     *
     * @return self
     */
    public function setSummaryResult($summaryResult)
    {
        if (is_null($summaryResult)) {
            throw new \InvalidArgumentException('non-nullable summaryResult cannot be null');
        }
        $this->container['summaryResult'] = $summaryResult;

        return $this;
    }

    /**
     * Gets packageLevelResults
     *
     * @return \OpenAPIClientUPSShipping\Model\VoidShipmentResponsePackageLevelResults[]|null
     */
    public function getPackageLevelResults()
    {
        return $this->container['packageLevelResults'];
    }

    /**
     * Sets packageLevelResults
     *
     * @param \OpenAPIClientUPSShipping\Model\VoidShipmentResponsePackageLevelResults[]|null $packageLevelResults Contains the Package Level Results.  **NOTE:** For versions >= v2403, this element will always be returned as an array. For requests using versions < v2403, this element will be returned as an array if there is more than one object and a single object if there is only 1.
     *
     * @return self
     */
    public function setPackageLevelResults($packageLevelResults)
    {
        if (is_null($packageLevelResults)) {
            throw new \InvalidArgumentException('non-nullable packageLevelResults cannot be null');
        }
        $this->container['packageLevelResults'] = $packageLevelResults;
