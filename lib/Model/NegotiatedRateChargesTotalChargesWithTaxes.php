...
class NegotiatedRateChargesTotalChargesWithTaxes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets currencyCode
     *
     * @param string $currencyCode TotalChargesWithTaxes currency code type. The currency code used in the Shipment request is returned.
     *
     * @return self
     */
    public function setCurrencyCode($currencyCode)
    {
        ...
        if ((mb_strlen($currencyCode) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling NegotiatedRateChargesTotalChargesWithTaxes., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currencyCode) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currencyCode when calling NegotiatedRateChargesTotalChargesWithTaxes., must be bigger than or equal to 3.');
        }
     ...
     * Sets monetaryValue
     *
     * @param string $monetaryValue TotalChargesWithTaxes monetary value amount.  Valid values are from 0 to 9999999999999999.99
     *
     * @return self
     */
    public function setMonetaryValue($monetaryValue)
    {
        ...
        if ((mb_strlen($monetaryValue) > 19)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling NegotiatedRateChargesTotalChargesWithTaxes., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($monetaryValue) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling NegotiatedRateChargesTotalChargesWithTaxes., must be bigger than or equal to 1.');
        }
