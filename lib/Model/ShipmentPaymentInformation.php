...
class ShipmentPaymentInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'shipmentCharge' => '\OpenAPIClientUPSShipping\Model\PaymentInformationShipmentCharge[]',
    ...
    protected static array $openAPINullables = [
        'shipmentCharge' => false,
        'splitDutyVATIndicator' => false
    ];
    ...
    protected static $setters = [
        'shipmentCharge' => 'setShipmentCharge',
        'splitDutyVATIndicator' => 'setSplitDutyVATIndicator'
    ];
    ...
    protected static $getters = [
        'shipmentCharge' => 'getShipmentCharge',
        'splitDutyVATIndicator' => 'getSplitDutyVATIndicator'
    ];
    ...
    {
        $this->setIfExists('shipmentCharge', $data ?? [], null);
        $this->setIfExists('splitDutyVATIndicator', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['shipmentCharge'] === null) {
            $invalidProperties[] = "'shipmentCharge' can't be null";
        }
     ...
     * Gets shipmentCharge
     *
     * @return \OpenAPIClientUPSShipping\Model\PaymentInformationShipmentCharge[]
     */
    public function getShipmentCharge()
    {
        return $this->container['shipmentCharge'];
    }

    /**
     * Sets shipmentCharge
     *
     * @param \OpenAPIClientUPSShipping\Model\PaymentInformationShipmentCharge[] $shipmentCharge shipmentCharge
     *
     * @return self
     */
    public function setShipmentCharge($shipmentCharge)
    {
        if (is_null($shipmentCharge)) {
            throw new \InvalidArgumentException('non-nullable shipmentCharge cannot be null');
        }


        $this->container['shipmentCharge'] = $shipmentCharge;

        return $this;
    }

    /**
     * Gets splitDutyVATIndicator
     *
     * @return string|null
     */
    public function getSplitDutyVATIndicator()
    {
        return $this->container['splitDutyVATIndicator'];
    }

    /**
     * Sets splitDutyVATIndicator
     *
     * @param string|null $splitDutyVATIndicator Split Duty VAT Indicator. The presence indicates the payer specified for Transportation Charges will pay transportation charges and any duties that apply to the shipment. The payer specified for Duties and Taxes will pay the VAT (Value-Added Tax) only.  This is an empty tag, any value inside is ignored. The payment method for Transportation charges must be UPS account. The UPS account must be a daily pickup account or an occasional account.
     *
     * @return self
     */
    public function setSplitDutyVATIndicator($splitDutyVATIndicator)
    {
        if (is_null($splitDutyVATIndicator)) {
            throw new \InvalidArgumentException('non-nullable splitDutyVATIndicator cannot be null');
        }


        $this->container['splitDutyVATIndicator'] = $splitDutyVATIndicator;
