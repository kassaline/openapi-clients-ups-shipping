...
class ShipmentResultsFRSShipmentData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'transportationCharges' => '\OpenAPIClientUPSShipping\Model\FRSShipmentDataTransportationCharges',
        'freightDensityRate' => '\OpenAPIClientUPSShipping\Model\FRSShipmentDataFreightDensityRate',
    ...
    protected static $setters = [
        ...
        'freightDensityRate' => 'setFreightDensityRate',
    ...
    protected static $getters = [
        ...
        'freightDensityRate' => 'getFreightDensityRate',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('freightDensityRate', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \OpenAPIClientUPSShipping\Model\FRSShipmentDataTransportationCharges
     */
     ...
     *
     * @param \OpenAPIClientUPSShipping\Model\FRSShipmentDataTransportationCharges $transportationCharges transportationCharges
     *
     * @return self
     */
    ...
    /**
     * Gets freightDensityRate
     *
     * @return \OpenAPIClientUPSShipping\Model\FRSShipmentDataFreightDensityRate|null
     */
    public function getFreightDensityRate()
    {
        return $this->container['freightDensityRate'];
    }

    /**
     * Sets freightDensityRate
     *
     * @param \OpenAPIClientUPSShipping\Model\FRSShipmentDataFreightDensityRate|null $freightDensityRate freightDensityRate
     *
     * @return self
     */
    public function setFreightDensityRate($freightDensityRate)
    {
        if (is_null($freightDensityRate)) {
            throw new \InvalidArgumentException('non-nullable freightDensityRate cannot be null');
        }
        $this->container['freightDensityRate'] = $freightDensityRate;
     ...
     * Gets handlingUnits
     *
     * @return \OpenAPIClientUPSShipping\Model\FRSShipmentDataHandlingUnits[]|null
     */
     ...
     * Sets handlingUnits
     *
     * @param \OpenAPIClientUPSShipping\Model\FRSShipmentDataHandlingUnits[]|null $handlingUnits Handling Unit for Density based rating container.  **NOTE:** For versions >= v2403, this element will always be returned as an array. For requests using versions < v2403, this element will be returned as an array if there is more than one object and a single object if there is only 1.
     *
     * @return self
     */
