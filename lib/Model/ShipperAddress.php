...
class ShipperAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets addressLine
     *
     * @param string[] $addressLine The Shipper street address including name and number (when applicable). Up to three occurrences are allowed; only the first is printed on the label.  35 characters are accepted, but for the first occurrence, only 30 characters will be printed on the label for return shipments.
     *
     * @return self
     */
     ...
     *
     * @param string|null $stateProvinceCode Shipper's state or province code.  For forward Shipment 5 characters are accepted, but only 2 characters will be printed on the label.  For US, PR and CA accounts, the account must be either a daily pickup account, an occasional account, or a customer B.I.N account.
     *
     * @return self
     */
    public function setStateProvinceCode($stateProvinceCode)
    {
        ...
        if ((mb_strlen($stateProvinceCode) > 5)) {
            throw new \InvalidArgumentException('invalid length for $stateProvinceCode when calling ShipperAddress., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($stateProvinceCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $stateProvinceCode when calling ShipperAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets postalCode
     *
     * @param string|null $postalCode Shipper's postal code.
     *
     * @return self
     */
    public function setPostalCode($postalCode)
    {
        ...
        if ((mb_strlen($postalCode) > 9)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling ShipperAddress., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($postalCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling ShipperAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets countryCode
     *
     * @param string $countryCode Shipper's country or territory code.  Refer to country or territory Codes in the Appendix for valid values.  Drop Shipper accounts are valid for return service shipments only if the account is Trade Direct (TD) enabled.
     *
     * @return self
     */
    public function setCountryCode($countryCode)
    {
        ...
        if ((mb_strlen($countryCode) > 2)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling ShipperAddress., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($countryCode) < 2)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling ShipperAddress., must be bigger than or equal to 2.');
        }
