...
class ProductExcludeFromForm implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets formType
     *
     * @param string[] $formType Indicates the name of the International form requested to NOT have product information.  Possible Values are 04 – NAFTA CO.  Please note that if this is used and you DO NOT have the corresponding form type requested this will be IGNORED.
     *
     * @return self
     */
