 ...
 */
class HighValueReportImageImageFormat implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HighValueReport_Image_ImageFormat';
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $code when calling HighValueReportImageImageFormat., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $code when calling HighValueReportImageImageFormat., must be bigger than or equal to 3.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Description of the High Value Report image format code.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 35)) {
            throw new \InvalidArgumentException('invalid length for $description when calling HighValueReportImageImageFormat., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling HighValueReportImageImageFormat., must be bigger than or equal to 1.');
        }
