    ...
    */
    ...
    public function setMonetaryValue($monetaryValue)
    {
        ...
        if ((mb_strlen($monetaryValue) > 15)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling InternationalFormsInsuranceCharges., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($monetaryValue) < 1)) {
            throw new \InvalidArgumentException('invalid length for $monetaryValue when calling InternationalFormsInsuranceCharges., must be bigger than or equal to 1.');
        }
