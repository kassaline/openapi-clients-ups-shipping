...
class SoldToAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets addressLine
     *
     * @param string[] $addressLine SoldTo location's street address.  Applies to NAFTA CO.
     *
     * @return self
     */
     ...
     *
     * @param string|null $stateProvinceCode SoldTo location's state or province code.  Required for certain countries or territories.
     *
     * @return self
     */
    public function setStateProvinceCode($stateProvinceCode)
    {
        ...
        if ((mb_strlen($stateProvinceCode) > 5)) {
            throw new \InvalidArgumentException('invalid length for $stateProvinceCode when calling SoldToAddress., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($stateProvinceCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $stateProvinceCode when calling SoldToAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets postalCode
     *
     * @param string|null $postalCode SoldTo location's postal code.
     *
     * @return self
     */
    public function setPostalCode($postalCode)
    {
        ...
        if ((mb_strlen($postalCode) > 9)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling SoldToAddress., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($postalCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling SoldToAddress., must be bigger than or equal to 1.');
        }
     ...
     * Sets countryCode
     *
     * @param string $countryCode SoldTo location's country or territory code.
     *
     * @return self
     */
    public function setCountryCode($countryCode)
    {
        ...
        if ((mb_strlen($countryCode) > 2)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling SoldToAddress., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($countryCode) < 2)) {
            throw new \InvalidArgumentException('invalid length for $countryCode when calling SoldToAddress., must be bigger than or equal to 2.');
        }
