...
class ShipmentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPIClientUPSShipping\Model\ShipmentResponseResponse',
        'shipmentResults' => '\OpenAPIClientUPSShipping\Model\ShipmentResponseShipmentResults'
    ];
    ...
    protected static $setters = [
        ...
        'shipmentResults' => 'setShipmentResults'
    ];
    ...
    protected static $getters = [
        ...
        'shipmentResults' => 'getShipmentResults'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('shipmentResults', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['shipmentResults'] === null) {
            $invalidProperties[] = "'shipmentResults' can't be null";
        }
     ...
     * Gets response
     *
     * @return \OpenAPIClientUPSShipping\Model\ShipmentResponseResponse
     */
     ...
     * Sets response
     *
     * @param \OpenAPIClientUPSShipping\Model\ShipmentResponseResponse $response response
     *
     * @return self
     */
    ...
    /**
     * Gets shipmentResults
     *
     * @return \OpenAPIClientUPSShipping\Model\ShipmentResponseShipmentResults
     */
    public function getShipmentResults()
    {
        return $this->container['shipmentResults'];
    }

    /**
     * Sets shipmentResults
     *
     * @param \OpenAPIClientUPSShipping\Model\ShipmentResponseShipmentResults $shipmentResults shipmentResults
     *
     * @return self
     */
    public function setShipmentResults($shipmentResults)
    {
        if (is_null($shipmentResults)) {
            throw new \InvalidArgumentException('non-nullable shipmentResults cannot be null');
        }
        $this->container['shipmentResults'] = $shipmentResults;
