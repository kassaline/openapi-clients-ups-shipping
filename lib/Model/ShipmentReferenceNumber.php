 ...
 *
 * @category Class
 * @description Reference Number information container. Required for Trade Direct shipments.
 * @package  OpenAPIClientUPSShipping
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class ShipmentReferenceNumber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        'barCodeIndicator' => 'setBarCodeIndicator',
        'code' => 'setCode',
        'value' => 'setValue'
    ];
    ...
    protected static $getters = [
        'barCodeIndicator' => 'getBarCodeIndicator',
        'code' => 'getCode',
        'value' => 'getValue'
    ];
    ...
    {
        $this->setIfExists('barCodeIndicator', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets barCodeIndicator
     *
     * @return string|null
     */
    public function getBarCodeIndicator()
    {
        return $this->container['barCodeIndicator'];
    }

    /**
     * Sets barCodeIndicator
     *
     * @param string|null $barCodeIndicator If the indicator is present then the reference number's value will be bar coded on the label.  This is an empty tag, any value inside is ignored. Only one shipment-level or package-level reference number can be bar coded per shipment. In order to barcode a reference number, its value must be no longer than 14 alphanumeric characters or 24 numeric characters and cannot contain spaces.
     *
     * @return self
     */
    public function setBarCodeIndicator($barCodeIndicator)
    {
        if (is_null($barCodeIndicator)) {
            throw new \InvalidArgumentException('non-nullable barCodeIndicator cannot be null');
        }


        $this->container['barCodeIndicator'] = $barCodeIndicator;
     ...
     * Sets code
     *
     * @param string|null $code Shipment Reference number type code. The code specifies the Reference name. Refer to the Reference Number Code table.  Valid if the origin/destination pair is not US/US or PR/PR and character should be alpha-numeric.
     *
     * @return self
     */
