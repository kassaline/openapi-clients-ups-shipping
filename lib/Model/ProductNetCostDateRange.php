...
class ProductNetCostDateRange implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['beginDate']) > 8)) {
            $invalidProperties[] = "invalid value for 'beginDate', the character length must be smaller than or equal to 8.";
        }

        if ((mb_strlen($this->container['beginDate']) < 8)) {
            $invalidProperties[] = "invalid value for 'beginDate', the character length must be bigger than or equal to 8.";
        }

        if ($this->container['endDate'] === null) {
            $invalidProperties[] = "'endDate' can't be null";
        }
        if ((mb_strlen($this->container['endDate']) > 8)) {
            $invalidProperties[] = "invalid value for 'endDate', the character length must be smaller than or equal to 8.";
        }

        if ((mb_strlen($this->container['endDate']) < 8)) {
            $invalidProperties[] = "invalid value for 'endDate', the character length must be bigger than or equal to 8.";
        }
     ...
     * Sets beginDate
     *
     * @param string $beginDate If the RVC is calculated over a period of time, it should be identified by the begin date (yyyyMMdd) of that period. (Reference: Articles 402.1, 402.5).  Applies to NAFTA CO only. Format is yyyyMMdd.
     *
     * @return self
     */
    public function setBeginDate($beginDate)
    {
        ...
        if ((mb_strlen($beginDate) > 8)) {
            throw new \InvalidArgumentException('invalid length for $beginDate when calling ProductNetCostDateRange., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($beginDate) < 8)) {
            throw new \InvalidArgumentException('invalid length for $beginDate when calling ProductNetCostDateRange., must be bigger than or equal to 8.');
        }
     ...
     * Sets endDate
     *
     * @param string $endDate If the RVC is calculated over a period of time, it should be identified by the End date (yyyyMMdd) of that period. (Reference: Articles 402.1, 402.5).  Applies to NAFTA CO only. Format is yyyyMMdd.
     *
     * @return self
     */
    public function setEndDate($endDate)
    {
        ...
        if ((mb_strlen($endDate) > 8)) {
            throw new \InvalidArgumentException('invalid length for $endDate when calling ProductNetCostDateRange., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($endDate) < 8)) {
            throw new \InvalidArgumentException('invalid length for $endDate when calling ProductNetCostDateRange., must be bigger than or equal to 8.');
        }
